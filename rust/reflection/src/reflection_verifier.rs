        ...
        table_verifier = match field.type_().base_type() {
            ...
            BaseType::Obj => {
                if let Some(field_pos) = table_verifier.deref(field.offset())? {
                    ...
                    return Ok(InvalidFlatbuffer::new_missing_required(
...
fn verify_vector<'a, 'b, 'c>(
    ...
    Ok(match field.type_().element() {
        ...
        BaseType::Bool => table_verifier.visit_field::<ForwardsUOffset<Vector<bool>>>(
            field_name,
            field.offset(),
            field.required(),
        )?,
        BaseType::Byte => table_verifier.visit_field::<ForwardsUOffset<Vector<i8>>>(
            field_name,
            field.offset(),
            field.required(),
        )?,
        BaseType::Short => table_verifier.visit_field::<ForwardsUOffset<Vector<i16>>>(
            field_name,
            field.offset(),
            field.required(),
        )?,
        BaseType::UShort => table_verifier.visit_field::<ForwardsUOffset<Vector<u16>>>(
            field_name,
            field.offset(),
            field.required(),
        )?,
        BaseType::Int => table_verifier.visit_field::<ForwardsUOffset<Vector<i32>>>(
            field_name,
            field.offset(),
            field.required(),
        )?,
        BaseType::UInt => table_verifier.visit_field::<ForwardsUOffset<Vector<u32>>>(
            field_name,
            field.offset(),
            field.required(),
        )?,
        BaseType::Long => table_verifier.visit_field::<ForwardsUOffset<Vector<i64>>>(
            field_name,
            field.offset(),
            field.required(),
        )?,
        BaseType::ULong => table_verifier.visit_field::<ForwardsUOffset<Vector<u64>>>(
            field_name,
            field.offset(),
            field.required(),
        )?,
        BaseType::Float => table_verifier.visit_field::<ForwardsUOffset<Vector<f32>>>(
            field_name,
            field.offset(),
            field.required(),
        )?,
        BaseType::Double => table_verifier.visit_field::<ForwardsUOffset<Vector<f64>>>(
            field_name,
            field.offset(),
            field.required(),
        )?,
