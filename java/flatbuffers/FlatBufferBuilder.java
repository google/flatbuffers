...
public class FlatBufferBuilder {
    ...
    static ByteBuffer growByteBuffer(ByteBuffer bb) {
        ...
        if(old_buf_size==0) { // 
            // Because existing bb could have a capacity of zero, this will cause
            // the new buf size to be also zero, which will not grow the buffer.
            // It will cause endless loop in the prep() function.
            old_buf_size = 1; 
        }
    ...
    public byte[] sizedByteArray() {
        return sizedByteArray(dataStart(), offset());
    }
}
