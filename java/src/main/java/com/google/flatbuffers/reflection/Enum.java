...
public final class Enum extends Table {
  ...
  public reflection.EnumVal values(int j) { return values(new reflection.EnumVal(), j); }
  public reflection.EnumVal values(reflection.EnumVal obj, int j) { int o = __offset(6); return o != 0 ? obj.__assign(__indirect(__vector(o) + j * 4), bb) : null; }
  public int valuesLength() { int o = __offset(6); return o != 0 ? __vector_len(o) : 0; }
  public reflection.EnumVal valuesByKey(long key) { int o = __offset(6); return o != 0 ? reflection.EnumVal.__lookup_by_key(null, __vector(o), key, bb) : null; }
  public reflection.EnumVal valuesByKey(reflection.EnumVal obj, long key) { int o = __offset(6); return o != 0 ? reflection.EnumVal.__lookup_by_key(obj, __vector(o), key, bb) : null; }
  public reflection.EnumVal.Vector valuesVector() { return valuesVector(new reflection.EnumVal.Vector()); }
  public reflection.EnumVal.Vector valuesVector(reflection.EnumVal.Vector obj) { int o = __offset(6); return o != 0 ? obj.__assign(__vector(o), 4, bb) : null; }
  public boolean isUnion() { int o = __offset(8); return o != 0 ? 0!=bb.get(o + bb_pos) : false; }
  public reflection.Type underlyingType() { return underlyingType(new reflection.Type()); }
  public reflection.Type underlyingType(reflection.Type obj) { int o = __offset(10); return o != 0 ? obj.__assign(__indirect(o + bb_pos), bb) : null; }
  public reflection.KeyValue attributes(int j) { return attributes(new reflection.KeyValue(), j); }
  public reflection.KeyValue attributes(reflection.KeyValue obj, int j) { int o = __offset(12); return o != 0 ? obj.__assign(__indirect(__vector(o) + j * 4), bb) : null; }
  public int attributesLength() { int o = __offset(12); return o != 0 ? __vector_len(o) : 0; }
  public reflection.KeyValue attributesByKey(String key) { int o = __offset(12); return o != 0 ? reflection.KeyValue.__lookup_by_key(null, __vector(o), key, bb) : null; }
  public reflection.KeyValue attributesByKey(reflection.KeyValue obj, String key) { int o = __offset(12); return o != 0 ? reflection.KeyValue.__lookup_by_key(obj, __vector(o), key, bb) : null; }
  public reflection.KeyValue.Vector attributesVector() { return attributesVector(new reflection.KeyValue.Vector()); }
  public reflection.KeyValue.Vector attributesVector(reflection.KeyValue.Vector obj) { int o = __offset(12); return o != 0 ? obj.__assign(__vector(o), 4, bb) : null; }
