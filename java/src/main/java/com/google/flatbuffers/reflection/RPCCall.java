...
public final class RPCCall extends Table {
  ...
  public reflection.Object request() { return request(new reflection.Object()); }
  public reflection.Object request(reflection.Object obj) { int o = __offset(6); return o != 0 ? obj.__assign(__indirect(o + bb_pos), bb) : null; }
  public reflection.Object response() { return response(new reflection.Object()); }
  public reflection.Object response(reflection.Object obj) { int o = __offset(8); return o != 0 ? obj.__assign(__indirect(o + bb_pos), bb) : null; }
  public reflection.KeyValue attributes(int j) { return attributes(new reflection.KeyValue(), j); }
  public reflection.KeyValue attributes(reflection.KeyValue obj, int j) { int o = __offset(10); return o != 0 ? obj.__assign(__indirect(__vector(o) + j * 4), bb) : null; }
  public int attributesLength() { int o = __offset(10); return o != 0 ? __vector_len(o) : 0; }
  public reflection.KeyValue attributesByKey(String key) { int o = __offset(10); return o != 0 ? reflection.KeyValue.__lookup_by_key(null, __vector(o), key, bb) : null; }
  public reflection.KeyValue attributesByKey(reflection.KeyValue obj, String key) { int o = __offset(10); return o != 0 ? reflection.KeyValue.__lookup_by_key(obj, __vector(o), key, bb) : null; }
  public reflection.KeyValue.Vector attributesVector() { return attributesVector(new reflection.KeyValue.Vector()); }
  public reflection.KeyValue.Vector attributesVector(reflection.KeyValue.Vector obj) { int o = __offset(10); return o != 0 ? obj.__assign(__vector(o), 4, bb) : null; }
