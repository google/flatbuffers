...
public final class Service extends Table {
  ...
  public reflection.RPCCall calls(int j) { return calls(new reflection.RPCCall(), j); }
  public reflection.RPCCall calls(reflection.RPCCall obj, int j) { int o = __offset(6); return o != 0 ? obj.__assign(__indirect(__vector(o) + j * 4), bb) : null; }
  public int callsLength() { int o = __offset(6); return o != 0 ? __vector_len(o) : 0; }
  public reflection.RPCCall callsByKey(String key) { int o = __offset(6); return o != 0 ? reflection.RPCCall.__lookup_by_key(null, __vector(o), key, bb) : null; }
  public reflection.RPCCall callsByKey(reflection.RPCCall obj, String key) { int o = __offset(6); return o != 0 ? reflection.RPCCall.__lookup_by_key(obj, __vector(o), key, bb) : null; }
  public reflection.RPCCall.Vector callsVector() { return callsVector(new reflection.RPCCall.Vector()); }
  public reflection.RPCCall.Vector callsVector(reflection.RPCCall.Vector obj) { int o = __offset(6); return o != 0 ? obj.__assign(__vector(o), 4, bb) : null; }
  public reflection.KeyValue attributes(int j) { return attributes(new reflection.KeyValue(), j); }
  public reflection.KeyValue attributes(reflection.KeyValue obj, int j) { int o = __offset(8); return o != 0 ? obj.__assign(__indirect(__vector(o) + j * 4), bb) : null; }
  public int attributesLength() { int o = __offset(8); return o != 0 ? __vector_len(o) : 0; }
  public reflection.KeyValue attributesByKey(String key) { int o = __offset(8); return o != 0 ? reflection.KeyValue.__lookup_by_key(null, __vector(o), key, bb) : null; }
  public reflection.KeyValue attributesByKey(reflection.KeyValue obj, String key) { int o = __offset(8); return o != 0 ? reflection.KeyValue.__lookup_by_key(obj, __vector(o), key, bb) : null; }
  public reflection.KeyValue.Vector attributesVector() { return attributesVector(new reflection.KeyValue.Vector()); }
  public reflection.KeyValue.Vector attributesVector(reflection.KeyValue.Vector obj) { int o = __offset(8); return o != 0 ? obj.__assign(__vector(o), 4, bb) : null; }
