...
public final class Object extends Table {
  ...
  public reflection.Field fields(int j) { return fields(new reflection.Field(), j); }
  public reflection.Field fields(reflection.Field obj, int j) { int o = __offset(6); return o != 0 ? obj.__assign(__indirect(__vector(o) + j * 4), bb) : null; }
  public int fieldsLength() { int o = __offset(6); return o != 0 ? __vector_len(o) : 0; }
  public reflection.Field fieldsByKey(String key) { int o = __offset(6); return o != 0 ? reflection.Field.__lookup_by_key(null, __vector(o), key, bb) : null; }
  public reflection.Field fieldsByKey(reflection.Field obj, String key) { int o = __offset(6); return o != 0 ? reflection.Field.__lookup_by_key(obj, __vector(o), key, bb) : null; }
  public reflection.Field.Vector fieldsVector() { return fieldsVector(new reflection.Field.Vector()); }
  public reflection.Field.Vector fieldsVector(reflection.Field.Vector obj) { int o = __offset(6); return o != 0 ? obj.__assign(__vector(o), 4, bb) : null; }
  ...
  public reflection.KeyValue attributes(reflection.KeyValue obj, int j) { int o = __offset(14); return o != 0 ? obj.__assign(__indirect(__vector(o) + j * 4), bb) : null; }
  public int attributesLength() { int o = __offset(14); return o != 0 ? __vector_len(o) : 0; }
  public reflection.KeyValue attributesByKey(String key) { int o = __offset(14); return o != 0 ? reflection.KeyValue.__lookup_by_key(null, __vector(o), key, bb) : null; }
  public reflection.KeyValue attributesByKey(reflection.KeyValue obj, String key) { int o = __offset(14); return o != 0 ? reflection.KeyValue.__lookup_by_key(obj, __vector(o), key, bb) : null; }
  public reflection.KeyValue.Vector attributesVector() { return attributesVector(new reflection.KeyValue.Vector()); }
  public reflection.KeyValue.Vector attributesVector(reflection.KeyValue.Vector obj) { int o = __offset(14); return o != 0 ? obj.__assign(__vector(o), 4, bb) : null; }
