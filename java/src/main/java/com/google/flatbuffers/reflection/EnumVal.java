...
public final class EnumVal extends Table {
  ...
  public reflection.Type unionType() { return unionType(new reflection.Type()); }
  public reflection.Type unionType(reflection.Type obj) { int o = __offset(10); return o != 0 ? obj.__assign(__indirect(o + bb_pos), bb) : null; }
