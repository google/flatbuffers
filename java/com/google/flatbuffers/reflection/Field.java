...
public final class Field extends Table {
  ...
  public KeyValue attribute(String key) {
    int vectorOffset = __vector(__offset(22)) - 4;
    return vectorOffset != 0 ? KeyValue.lookupByKey(bb.array().length - vectorOffset, key, bb) : null;
  }
