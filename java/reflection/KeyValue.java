...
public final class KeyValue extends Table {
  ...
  public static KeyValue getRootAsKeyValue(ByteBuffer _bb, KeyValue obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__init(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  public KeyValue __init(int _i, ByteBuffer _bb) { bb_pos = _i; bb = _bb; return this; }
  ...
  public static KeyValue lookupByKey(int vectorOffset, String key, ByteBuffer bb) {
    ...
    while (span != 0) {
      ...
      if (comp > 0) {
        ...
        return new KeyValue().__init(tableOffset, bb);
      }
    }
    return null;
  }
