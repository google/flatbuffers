...
public final class EnumVal extends Table {
  ...
  public static EnumVal getRootAsEnumVal(ByteBuffer _bb, EnumVal obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__init(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  public EnumVal __init(int _i, ByteBuffer _bb) { bb_pos = _i; bb = _bb; return this; }
  ...
  public Object object(Object obj) { int o = __offset(8); return o != 0 ? obj.__init(__indirect(o + bb_pos), bb) : null; }
  ...
  public static EnumVal lookupByKey(int vectorOffset, long key, ByteBuffer bb) {
    ...
    while (span != 0) {
      ...
      if (comp > 0) {
        ...
        return new EnumVal().__init(tableOffset, bb);
      }
    }
    return null;
  }
