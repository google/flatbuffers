...
impl<'a> Monster<'a> {
    ...
    pub fn unpack(&self) -> MonsterT {
        ...
        let equipped = match self.equipped_type() {
            super::Equipment::NONE => super::EquipmentT::NONE,
            super::Equipment::Weapon => super::EquipmentT::Weapon(alloc::boxed::Box::new(
                self.equipped_as_weapon()
                    .expect("Invalid union table, expected `super::Equipment::Weapon`.")
                    .unpack()
            )),
            _ => super::EquipmentT::NONE,
        };
    ...
    #[inline]
    pub fn weapons(&self) -> Option<::flatbuffers::Vector<'a, ::flatbuffers::ForwardsUOffset<super::Weapon<'a>>>> {
        // Safety:
        // Created from valid Table for this object
        // which contains a valid value in this slot
        unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<::flatbuffers::Vector<'a, ::flatbuffers::ForwardsUOffset<super::Weapon>>>>(Monster::VT_WEAPONS, None)}
    }

    #[inline]
    pub fn equipped_type(&self) -> super::Equipment {
        // Safety:
        // Created from valid Table for this object
        // which contains a valid value in this slot
        unsafe { self._tab.get::<super::Equipment>(Monster::VT_EQUIPPED_TYPE, Some(super::Equipment::NONE)).unwrap()}
    }
    ...
    #[inline]
    pub fn path(&self) -> Option<::flatbuffers::Vector<'a, super::Vec3>> {
        // Safety:
        // Created from valid Table for this object
        // which contains a valid value in this slot
        unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<::flatbuffers::Vector<'a, super::Vec3>>>(Monster::VT_PATH, None)}
    }

    #[inline]
    #[allow(non_snake_case)]
    pub fn equipped_as_weapon(&self) -> Option<super::Weapon<'a>> {
        if self.equipped_type() == super::Equipment::Weapon {
            self.equipped().map(|t| {
                // Safety:
                // Created from a valid Table for this object
                // Which contains a valid union in this slot
                unsafe { super::Weapon::init_from_table(t) }
            })
        } else {
            None
        }
...
impl ::flatbuffers::Verifiable for Monster<'_> {
    ...
    fn run_verifier(
        ...
        v.visit_table(pos)?
            ...
            .visit_field::<::flatbuffers::ForwardsUOffset<::flatbuffers::Vector<'_, ::flatbuffers::ForwardsUOffset<super::Weapon>>>>("weapons", Self::VT_WEAPONS, false)?
            .visit_union::<super::Equipment, _>("equipped_type", Self::VT_EQUIPPED_TYPE, "equipped", Self::VT_EQUIPPED, false, |key, v, pos| {
                match key {
                    super::Equipment::Weapon => v.verify_union_variant::<::flatbuffers::ForwardsUOffset<super::Weapon>>("super::Equipment::Weapon", pos),
                    _ => Ok(()),
                }
            })?
            .visit_field::<::flatbuffers::ForwardsUOffset<::flatbuffers::Vector<'_, super::Vec3>>>("path", Self::VT_PATH, false)?
            .finish();
        Ok(())
    }
}
...
pub struct MonsterArgs<'a> {
    ...
    pub weapons: Option<::flatbuffers::WIPOffset<::flatbuffers::Vector<'a, ::flatbuffers::ForwardsUOffset<super::Weapon<'a>>>>>,
    pub equipped_type: super::Equipment,
    pub equipped: Option<::flatbuffers::WIPOffset<::flatbuffers::UnionWIPOffset>>,
    pub path: Option<::flatbuffers::WIPOffset<::flatbuffers::Vector<'a, super::Vec3>>>,
}
...
impl<'a> Default for MonsterArgs<'a> {
    ...
    fn default() -> Self {
        MonsterArgs {
            ...
            weapons: None,
            equipped_type: super::Equipment::NONE,
            equipped: None,
            path: None,
        }
    }
...
impl<'a: 'b, 'b, A: ::flatbuffers::Allocator + 'a> MonsterBuilder<'a, 'b, A> {
    ...
    #[inline]
    pub fn add_weapons(&mut self, weapons: ::flatbuffers::WIPOffset<::flatbuffers::Vector<'b , ::flatbuffers::ForwardsUOffset<super::Weapon<'b >>>>) {
        self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(Monster::VT_WEAPONS, weapons);
    }

    #[inline]
    pub fn add_equipped_type(&mut self, equipped_type: super::Equipment) {
        self.fbb_.push_slot::<super::Equipment>(Monster::VT_EQUIPPED_TYPE, equipped_type, super::Equipment::NONE);
    }
    ...
    #[inline]
    pub fn add_path(&mut self, path: ::flatbuffers::WIPOffset<::flatbuffers::Vector<'b , super::Vec3>>) {
...
pub struct MonsterT {
    ...
    pub color: super::Color,
    pub weapons: Option<alloc::vec::Vec<super::WeaponT>>,
    pub equipped: super::EquipmentT,
    pub path: Option<alloc::vec::Vec<super::Vec3T>>,
}
...
impl Default for MonsterT {
    fn default() -> Self {
        Self {
            ...
            color: super::Color::Blue,
            weapons: None,
            equipped: super::EquipmentT::NONE,
            path: None,
        }
    }
}
