...
impl<'a> Monster<'a> {
    ...
    pub fn name(&self) -> Option<&'a str> {
        ...
        // Created from valid Table for this object
        // which contains a valid value in this slot
        unsafe { self.tab.get::<::flatbuffers::ForwardsUOffset<&str>>(Monster::VT_NAME, None)}
    }
    ...
    pub fn weapons(&self) -> Option<::flatbuffers::Vector<'a, ::flatbuffers::ForwardsUOffset<Weapon<'a>>>> {
        ...
        // Created from valid Table for this object
        // which contains a valid value in this slot
        unsafe { self.tab.get::<::flatbuffers::ForwardsUOffset<::flatbuffers::Vector<'a, ::flatbuffers::ForwardsUOffset<Weapon>>>>(Monster::VT_WEAPONS, None)}
    }
    ...
    pub fn equipped_type(&self) -> Equipment {
        ...
        // Created from valid Table for this object
        // which contains a valid value in this slot
        unsafe { self.tab.get::<Equipment>(Monster::VT_EQUIPPED_TYPE, Some(Equipment::NONE)).unwrap()}
    }
    ...
    pub fn equipped(&self) -> Option<::flatbuffers::Table<'a>> {
        ...
        // Created from valid Table for this object
        // which contains a valid value in this slot
        unsafe { self.tab.get::<::flatbuffers::ForwardsUOffset<::flatbuffers::Table<'a>>>(Monster::VT_EQUIPPED, None)}
    }
    ...
    pub fn path(&self) -> Option<::flatbuffers::Vector<'a, Vec3>> {
        ...
        // Created from valid Table for this object
        // which contains a valid value in this slot
        unsafe { self.tab.get::<::flatbuffers::ForwardsUOffset<::flatbuffers::Vector<'a, Vec3>>>(Monster::VT_PATH, None)}
    }
...
impl MonsterT {
    ...
    pub fn pack<'b, A: ::flatbuffers::Allocator + 'b>(
        ...
        let equipped = self.equipped.pack(fbb);
        debug_assert!(equipped.is_some() || equipped_type == Equipment::NONE, "Union discriminant does not match packed value");
