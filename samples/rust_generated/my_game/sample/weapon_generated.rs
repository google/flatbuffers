...
impl<'a> Weapon<'a> {
    ...
    pub fn name(&self) -> Option<&'a str> {
        ...
        unsafe { self.tab.get::<::flatbuffers::ForwardsUOffset<&str>>(Weapon::VT_NAME, None)}
    }
    ...
    pub fn damage(&self) -> i16 {
        ...
        // Created from valid Table for this object
        // which contains a valid value in this slot
        unsafe { self.tab.get::<i16>(Weapon::VT_DAMAGE, Some(0)).unwrap()}
    }
}
