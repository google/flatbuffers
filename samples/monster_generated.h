...
bool VerifyEquipment(::flatbuffers::VerifierTemplate<B>& verifier,
...
template <bool B>
inline bool VerifyEquipment(::flatbuffers::VerifierTemplate<B>& verifier,
                            const void* obj, Equipment type) {
  switch (type) {
    case Equipment_NONE: {
      return true;
...
inline bool VerifySizePrefixedMonsterBuffer(
    ::flatbuffers::VerifierTemplate<B>& verifier) {
  return verifier.template VerifySizePrefixedBuffer<MyGame::Sample::Monster>(
      nullptr);
}
