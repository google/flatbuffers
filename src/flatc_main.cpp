...
int main(int argc, const char *argv[]) {
  ...
  const flatbuffers::FlatCompiler::Generator generators[] = {
    ...
    { flatbuffers::GenerateCPPNative, "-N", "--native", "C++ Native", true,
      nullptr, flatbuffers::IDLOptions::kCppNative,
      "Generate C++ headers native tables/structs", flatbuffers::GeneralMakeRule },
