    ...
    switch (field.value.type.base_type) {
        ...
        switch (vector_type.base_type) {
          ...
          case BASE_TYPE_STRUCT: {
            if (IsStruct(vector_type)) {
              ...
              code += "(" + value + ".size(), ";
              code += "[](size_t i, _VectorArgs *__va) { ";
              code += "return " + WrapInNameSpace(vector_type.struct_def->defined_namespace, "Create" + vector_type.struct_def->name);
              code += "(*__va->__fbb, ";
      ...
      case BASE_TYPE_STRUCT: {
        if (IsStruct(field.value.type)) {
          ...
          code += value + " ? " + WrapInNameSpace(nested_struct.defined_namespace, "Create" + nested_struct.name);
          code += "(_fbb, " + value;
