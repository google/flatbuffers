...
class JsGenerator : public BaseGenerator {
 ...
 private:
  ...
  void GenEnum(EnumDef &enum_def, std::string *code_ptr,
    ...
    if (ts) {
      code += "export namespace " + FullNamespace(qualifying_separator_.c_str(), *enum_def.defined_namespace) + "{\n";
  ...
  void GenStruct(const Parser &parser, StructDef &struct_def, std::string *code_ptr, std::string *exports_ptr) {
    ...
    if (ts) {
      code += "export namespace " + FullNamespace(qualifying_separator_.c_str(), *struct_def.defined_namespace) + "{\n";
