...
exports.reflectUnpack = reflectUnpack;
exports.reflectPack = reflectPack;
 ...
 * ```
 */
function reflectUnpack(schema, typeName, buf) {
...
function unpackFieldIntoRecord(buf, tablePos, name, abs, fieldType, obj, schema, result) {
    switch (fieldType.baseType()) {
        ...
        case reflection_1.ReflectionBaseType.UType:
            ...
            break;
        case reflection_1.ReflectionBaseType.Union:
 ...
 * ```
 */
function reflectPack(schema, typeName, inputObj) {
    const obj = schema.objectByName(typeName);
    if (obj == null)
        return null;
