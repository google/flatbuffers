...
export declare class Verifier {
     ...
     */
    checkVectorOfTables(pos: number, verifyElem: (v: Verifier, pos: number) => void): void;
    /**
     ...
     *   `_resolveVtableField`.
     */
    checkRequiredField(tablePos: number, vOffset: number, fieldName: string): void;
    /**
     ...
     */
    checkUnionConsistency(tablePos: number, typeVOffset: number, valueVOffset: number, fieldName: string): void;
    /**
