...
exports.ReflectionSchema = exports.ReflectionEnum = exports.ReflectionEnumVal = exports.ReflectionKeyValue = exports.ReflectionObject = exports.ReflectionField = exports.ReflectionType = exports.ReflectionBaseType = void 0;
exports.getFieldString = getFieldString;
exports.getFieldInt = getFieldInt;
exports.getFieldFloat = getFieldFloat;
...
})(ReflectionBaseType || (exports.ReflectionBaseType = ReflectionBaseType = {}));
// ── vtable primitives ──────────────────────────────────────────────────────
/**
...
exports.ReflectionObject = ReflectionObject;
...
exports.ReflectionKeyValue = ReflectionKeyValue;
// ── ReflectionEnumVal ──────────────────────────────────────────────────────
/**
...
exports.ReflectionEnumVal = ReflectionEnumVal;
// ── ReflectionEnum ─────────────────────────────────────────────────────────
/**
...
exports.ReflectionEnum = ReflectionEnum;
// ── ReflectionSchema ───────────────────────────────────────────────────────
/**
...
exports.ReflectionSchema = ReflectionSchema;
 ...
 * ```
 */
function getFieldString(dataBuf, tablePos, field) {
 ...
 * ```
 */
function getFieldInt(dataBuf, tablePos, field) {
    const fieldPos = resolveFieldPos(dataBuf, tablePos, field);
    if (fieldPos === null)
        return null;
    const fieldType = field.type();
 ...
 * ```
 */
function getFieldFloat(dataBuf, tablePos, field) {
    const fieldPos = resolveFieldPos(dataBuf, tablePos, field);
    if (fieldPos === null)
        return null;
    const fieldType = field.type();
 ...
 * ```
 */
function getFieldBool(dataBuf, tablePos, field) {
    const fieldPos = resolveFieldPos(dataBuf, tablePos, field);
    if (fieldPos === null)
        return null;
