...
**When using the obj based API, the flatbuffers import need to be in the global namespace** since creating default values require accessing the `flatbuffers.js` file.
