...
public final class InParentNamespace extends Table {
  ...
  public static InParentNamespace getSizePrefixedRootAsInParentNamespace(ByteBuffer _bb, InParentNamespace obj) { ByteBuffer __bb = _bb.slice(); __bb.position(Constants.SIZE_PREFIX_LENGTH); return getRootAsInParentNamespace(__bb, obj); }
