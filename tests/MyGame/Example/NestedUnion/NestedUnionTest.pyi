...
class NestedUnionTestT(object):
  ...
  id: int
  def __init__(self, name: str | None = ..., dataType: typing.Literal[Any.NONE, Any.Vec3, Any.TestSimpleTableWithEnum] = ..., data: typing.Union[None, 'Vec3T', 'TestSimpleTableWithEnumT'] = ..., id: int = ...) -> None: ...
  @classmethod
