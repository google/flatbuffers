...
struct Vec3 {
  ...
  @property   ubyte test2() { return _buffer.get!ubyte(_pos + 24); }
  @property   Nullable!Test test3() { return Nullable!Test(Test.init_(_pos + 26, _buffer)); }

  static int createVec3(FlatBufferBuilder builder, float x, float y, float z, double test1, ubyte test2, short Test_a, ubyte Test_b) {
    builder.prep(16, 32);
    builder.pad(2);
    builder.prep(2, 4);
    builder.pad(1);
    builder.put!ubyte(Test_b);
    builder.put!short(Test_a);
    builder.pad(1);
    builder.put!ubyte(test2);
