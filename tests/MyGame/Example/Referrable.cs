...
public struct Referrable : IFlatbufferObject
{
  ...
  public static Offset<global::MyGame.Example.Referrable> CreateReferrable(FlatBufferBuilder builder,
      ulong id = 0) {
  ...
  public static Offset<global::MyGame.Example.Referrable> EndReferrable(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<global::MyGame.Example.Referrable>(o);
  }
  ...
  public static Offset<global::MyGame.Example.Referrable> Pack(FlatBufferBuilder builder, ReferrableT _o) {
    if (_o == null) return default(Offset<global::MyGame.Example.Referrable>);
