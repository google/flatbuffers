...
function Monster_mt:StringWithMax()
    local o = self.view:Offset(114)
    if o ~= 0 then
        return self.view:String(o + self.view.pos)
    end
end
function Monster.Start(builder) builder:StartObject(56) end
...
function Monster.AddStringWithMax(builder, stringWithMax) builder:PrependUOffsetTRelativeSlot(55, stringWithMax, 0) end
