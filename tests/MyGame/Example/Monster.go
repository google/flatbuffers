...
func (rcv *Monster) VecOfEnumsWithMaxBytes() []byte {
	o := flatbuffers.UOffsetT(rcv._tab.Offset(112))
	if o != 0 {
		return rcv._tab.ByteVector(o + rcv._tab.Pos)
	}
...
func (rcv *Monster) StringWithMax() []byte {
...
func MonsterAddStringWithMax(builder *flatbuffers.Builder, stringWithMax flatbuffers.UOffsetT) {
	builder.PrependUOffsetTSlot(55, flatbuffers.UOffsetT(stringWithMax), 0)
}
