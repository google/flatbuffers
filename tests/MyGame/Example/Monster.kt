...
class Monster : Table() {
    ...
    val color : Int
        get() {
            val o = __offset(16)
            return if(o != 0) bb.get(o + bb_pos).toInt().and(0xFF) else 8
        }
    ...
    fun mutateTestType(testType: Byte) : Boolean {
        val o = __offset(18)
        return if (o != 0) {
            bb.put(o + bb_pos, testType)
            true
        } else {
            false
        }
    ...
    fun testnestedflatbuffer(j: Int) : Int {
        val o = __offset(30)
        return if (o != 0) {
            bb.get(__vector(o) + j * 1).toInt().and(0xFF)
        } else {
    ...
    fun mutateTestnestedflatbuffer(j: Int, testnestedflatbuffer: Int) : Boolean {
        val o = __offset(30)
        return if (o != 0) {
    ...
    val testhashu32Fnv1 : Long
        get() {
            val o = __offset(38)
            return if(o != 0) bb.getInt(o + bb_pos).toLong().and(0xFFFFFFFFL) else 0L
        }
    fun mutateTesthashu32Fnv1(testhashu32Fnv1: Long) : Boolean {
        val o = __offset(38)
        return if (o != 0) {
    ...
    val testhashu64Fnv1 : Long
        get() {
            val o = __offset(42)
            return if(o != 0) bb.getLong(o + bb_pos) else 0L
        }
    fun mutateTesthashu64Fnv1(testhashu64Fnv1: Long) : Boolean {
        val o = __offset(42)
        return if (o != 0) {
            bb.putLong(o + bb_pos, testhashu64Fnv1)
            true
        } else {
            false
        }
    ...
    val testhashu32Fnv1a : Long
        get() {
            val o = __offset(46)
            return if(o != 0) bb.getInt(o + bb_pos).toLong().and(0xFFFFFFFFL) else 0L
        }
    fun mutateTesthashu32Fnv1a(testhashu32Fnv1a: Long) : Boolean {
        val o = __offset(46)
        return if (o != 0) {
    ...
    val testhashu64Fnv1a : Long
        get() {
            val o = __offset(50)
            return if(o != 0) bb.getLong(o + bb_pos) else 0L
        }
    fun mutateTesthashu64Fnv1a(testhashu64Fnv1a: Long) : Boolean {
        val o = __offset(50)
        return if (o != 0) {
            bb.putLong(o + bb_pos, testhashu64Fnv1a)
            true
        } else {
            false
        }
    ...
    fun mutateFlex(j: Int, flex: Int) : Boolean {
        val o = __offset(64)
        return if (o != 0) {
    ...
    fun vectorOfReferrablesByKey(key: Long) : MyGame.Example.Referrable? {
        val o = __offset(74)
        return if (o != 0) {
    ...
    fun vectorOfReferrablesByKey(obj: MyGame.Example.Referrable, key: Long) : MyGame.Example.Referrable? {
        val o = __offset(74)
        return if (o != 0) {
    ...
    val singleWeakReference : Long
        get() {
            val o = __offset(76)
            return if(o != 0) bb.getLong(o + bb_pos) else 0L
        }
    fun mutateSingleWeakReference(singleWeakReference: Long) : Boolean {
        val o = __offset(76)
        return if (o != 0) {
            bb.putLong(o + bb_pos, singleWeakReference)
            true
        } else {
            false
        }
    }
    fun vectorOfWeakReferences(j: Int) : Long {
        val o = __offset(78)
        return if (o != 0) {
            bb.getLong(__vector(o) + j * 8)
        } else {
    ...
    fun mutateVectorOfWeakReferences(j: Int, vectorOfWeakReferences: Long) : Boolean {
        val o = __offset(78)
        return if (o != 0) {
            bb.putLong(__vector(o) + j * 8, vectorOfWeakReferences)
            true
        } else {
            false
        }
    ...
    fun vectorOfStrongReferrablesByKey(key: Long) : MyGame.Example.Referrable? {
        val o = __offset(80)
        return if (o != 0) {
            MyGame.Example.Referrable.__lookup_by_key(null, __vector(o), key, bb)
        } else {
    ...
    fun vectorOfStrongReferrablesByKey(obj: MyGame.Example.Referrable, key: Long) : MyGame.Example.Referrable? {
        val o = __offset(80)
        return if (o != 0) {
            MyGame.Example.Referrable.__lookup_by_key(obj, __vector(o), key, bb)
        } else {
    ...
    val coOwningReference : Long
        get() {
            val o = __offset(82)
            return if(o != 0) bb.getLong(o + bb_pos) else 0L
        }
    fun mutateCoOwningReference(coOwningReference: Long) : Boolean {
        val o = __offset(82)
        return if (o != 0) {
            bb.putLong(o + bb_pos, coOwningReference)
            true
        } else {
            false
        }
    }
    fun vectorOfCoOwningReferences(j: Int) : Long {
        val o = __offset(84)
        return if (o != 0) {
            bb.getLong(__vector(o) + j * 8)
        } else {
    ...
    fun mutateVectorOfCoOwningReferences(j: Int, vectorOfCoOwningReferences: Long) : Boolean {
        val o = __offset(84)
        return if (o != 0) {
            bb.putLong(__vector(o) + j * 8, vectorOfCoOwningReferences)
            true
        } else {
            false
        }
    }
    val nonOwningReference : Long
        get() {
            val o = __offset(86)
            return if(o != 0) bb.getLong(o + bb_pos) else 0L
        }
    fun mutateNonOwningReference(nonOwningReference: Long) : Boolean {
        val o = __offset(86)
        return if (o != 0) {
            bb.putLong(o + bb_pos, nonOwningReference)
            true
        } else {
            false
        }
    }
    fun vectorOfNonOwningReferences(j: Int) : Long {
        val o = __offset(88)
        return if (o != 0) {
            bb.getLong(__vector(o) + j * 8)
        } else {
    ...
    fun mutateVectorOfNonOwningReferences(j: Int, vectorOfNonOwningReferences: Long) : Boolean {
        val o = __offset(88)
        return if (o != 0) {
            bb.putLong(__vector(o) + j * 8, vectorOfNonOwningReferences)
            true
        } else {
            false
        }
    }
    val anyUniqueType : Byte
        get() {
            val o = __offset(90)
            return if(o != 0) bb.get(o + bb_pos) else 0
        }
    fun mutateAnyUniqueType(anyUniqueType: Byte) : Boolean {
        val o = __offset(90)
        return if (o != 0) {
            bb.put(o + bb_pos, anyUniqueType)
            true
        } else {
            false
        }
    ...
    val anyAmbiguousType : Byte
        get() {
            val o = __offset(94)
            return if(o != 0) bb.get(o + bb_pos) else 0
        }
    fun mutateAnyAmbiguousType(anyAmbiguousType: Byte) : Boolean {
        val o = __offset(94)
        return if (o != 0) {
            bb.put(o + bb_pos, anyAmbiguousType)
            true
        } else {
            false
        }
    ...
    fun mutateVectorOfEnums(j: Int, vectorOfEnums: Int) : Boolean {
        val o = __offset(98)
        return if (o != 0) {
    ...
    companion object {
        ...
        fun addMana(builder: FlatBufferBuilder, mana: Short) = builder.addShort(1, mana, 150.toInt())
        fun addHp(builder: FlatBufferBuilder, hp: Short) = builder.addShort(2, hp, 100.toInt())
        ...
        fun addColor(builder: FlatBufferBuilder, color: Int) = builder.addByte(6, color.toByte(), 8)
        fun addTestType(builder: FlatBufferBuilder, testType: Byte) = builder.addByte(7, testType, 0.toInt())
        ...
        fun createTestnestedflatbufferVector(builder: FlatBufferBuilder, data: ByteArray) : Int {
            builder.startVector(1, data.size, 1)
            for (i in data.size - 1 downTo 0) {
                builder.addByte(data[i])
            }
        ...
        fun addTesthashu32Fnv1(builder: FlatBufferBuilder, testhashu32Fnv1: Long) = builder.addInt(17, testhashu32Fnv1.toInt(), 0L.toInt())
        fun addTesthashs64Fnv1(builder: FlatBufferBuilder, testhashs64Fnv1: Long) = builder.addLong(18, testhashs64Fnv1, 0L)
        fun addTesthashu64Fnv1(builder: FlatBufferBuilder, testhashu64Fnv1: Long) = builder.addLong(19, testhashu64Fnv1, 0L)
        fun addTesthashs32Fnv1a(builder: FlatBufferBuilder, testhashs32Fnv1a: Int) = builder.addInt(20, testhashs32Fnv1a, 0)
        fun addTesthashu32Fnv1a(builder: FlatBufferBuilder, testhashu32Fnv1a: Long) = builder.addInt(21, testhashu32Fnv1a.toInt(), 0L.toInt())
        fun addTesthashs64Fnv1a(builder: FlatBufferBuilder, testhashs64Fnv1a: Long) = builder.addLong(22, testhashs64Fnv1a, 0L)
        fun addTesthashu64Fnv1a(builder: FlatBufferBuilder, testhashu64Fnv1a: Long) = builder.addLong(23, testhashu64Fnv1a, 0L)
        ...
        fun addTestf(builder: FlatBufferBuilder, testf: Float) = builder.addFloat(25, testf, 3.14159f.toDouble())
        fun addTestf2(builder: FlatBufferBuilder, testf2: Float) = builder.addFloat(26, testf2, 3.0f.toDouble())
        fun addTestf3(builder: FlatBufferBuilder, testf3: Float) = builder.addFloat(27, testf3, 0.0f.toDouble())
        ...
        fun createFlexVector(builder: FlatBufferBuilder, data: ByteArray) : Int {
            builder.startVector(1, data.size, 1)
            for (i in data.size - 1 downTo 0) {
                builder.addByte(data[i])
            }
        ...
        fun addSingleWeakReference(builder: FlatBufferBuilder, singleWeakReference: Long) = builder.addLong(36, singleWeakReference, 0L)
        ...
        fun createVectorOfWeakReferencesVector(builder: FlatBufferBuilder, data: LongArray) : Int {
            builder.startVector(8, data.size, 8)
            for (i in data.size - 1 downTo 0) {
                builder.addLong(data[i])
            }
        ...
        fun addCoOwningReference(builder: FlatBufferBuilder, coOwningReference: Long) = builder.addLong(39, coOwningReference, 0L)
        ...
        fun createVectorOfCoOwningReferencesVector(builder: FlatBufferBuilder, data: LongArray) : Int {
            builder.startVector(8, data.size, 8)
            for (i in data.size - 1 downTo 0) {
                builder.addLong(data[i])
            }
        ...
        fun addNonOwningReference(builder: FlatBufferBuilder, nonOwningReference: Long) = builder.addLong(41, nonOwningReference, 0L)
        ...
        fun createVectorOfNonOwningReferencesVector(builder: FlatBufferBuilder, data: LongArray) : Int {
            builder.startVector(8, data.size, 8)
            for (i in data.size - 1 downTo 0) {
                builder.addLong(data[i])
            }
        ...
        fun addAnyUniqueType(builder: FlatBufferBuilder, anyUniqueType: Byte) = builder.addByte(43, anyUniqueType, 0.toInt())
        fun addAnyUnique(builder: FlatBufferBuilder, anyUnique: Int) = builder.addOffset(44, anyUnique, 0)
        fun addAnyAmbiguousType(builder: FlatBufferBuilder, anyAmbiguousType: Byte) = builder.addByte(45, anyAmbiguousType, 0.toInt())
        ...
        fun createVectorOfEnumsVector(builder: FlatBufferBuilder, data: ByteArray) : Int {
            builder.startVector(1, data.size, 1)
            for (i in data.size - 1 downTo 0) {
                builder.addByte(data[i])
            }
