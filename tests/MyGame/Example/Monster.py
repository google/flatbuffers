...
# /// multiline too
    ...
    # Monster
    def StringWithMax(self):
        o = flatbuffers.number_types.UOffsetTFlags.py_type(self._tab.Offset(114))
        if o != 0:
            return self._tab.String(o + self._tab.Pos)
        return None

def MonsterStart(builder): builder.StartObject(56)
...
def MonsterAddStringWithMax(builder, stringWithMax): builder.PrependUOffsetTRelativeSlot(55, flatbuffers.number_types.UOffsetTFlags.py_type(stringWithMax), 0)
