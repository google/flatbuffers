...
class MonsterT(object):
    ...
    def __init__(
        ...
        self.inventory = inventory  # type: List[int]
        ...
        self.test4 = test4  # type: List[MyGame.Example.Test.TestT]
        self.testarrayofstring = testarrayofstring  # type: List[str]
        self.testarrayoftables = testarrayoftables  # type: List[MyGame.Example.Monster.MonsterT]
        self.enemy = enemy  # type: Optional[MyGame.Example.Monster.MonsterT]
        self.testnestedflatbuffer = testnestedflatbuffer  # type: List[int]
        ...
        self.testarrayofbools = testarrayofbools  # type: List[bool]
        self.testf = testf  # type: float
        self.testf2 = testf2  # type: float
        self.testf3 = testf3  # type: float
        self.testarrayofstring2 = testarrayofstring2  # type: List[str]
        self.testarrayofsortedstruct = testarrayofsortedstruct  # type: List[MyGame.Example.Ability.AbilityT]
        self.flex = flex  # type: List[int]
        self.test5 = test5  # type: List[MyGame.Example.Test.TestT]
        self.vectorOfLongs = vectorOfLongs  # type: List[int]
        self.vectorOfDoubles = vectorOfDoubles  # type: List[float]
        self.parentNamespaceTest = parentNamespaceTest  # type: Optional[MyGame.InParentNamespace.InParentNamespaceT]
        self.vectorOfReferrables = vectorOfReferrables  # type: List[MyGame.Example.Referrable.ReferrableT]
        self.singleWeakReference = singleWeakReference  # type: int
        self.vectorOfWeakReferences = vectorOfWeakReferences  # type: List[int]
        self.vectorOfStrongReferrables = vectorOfStrongReferrables  # type: List[MyGame.Example.Referrable.ReferrableT]
        self.coOwningReference = coOwningReference  # type: int
        self.vectorOfCoOwningReferences = vectorOfCoOwningReferences  # type: List[int]
        self.nonOwningReference = nonOwningReference  # type: int
        self.vectorOfNonOwningReferences = vectorOfNonOwningReferences  # type: List[int]
        ...
        self.vectorOfEnums = vectorOfEnums  # type: List[int]
        self.signedEnum = signedEnum  # type: int
        self.testrequirednestedflatbuffer = testrequirednestedflatbuffer  # type: List[int]
        self.scalarKeySortedTables = scalarKeySortedTables  # type: List[MyGame.Example.Stat.StatT]
