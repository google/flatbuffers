...
public struct TypeAliases : IFlatbufferObject
{
  ...
  public static Offset<global::MyGame.Example.TypeAliases> CreateTypeAliases(FlatBufferBuilder builder,
      sbyte i8 = 0,
      byte u8 = 0,
      short i16 = 0,
      ushort u16 = 0,
  ...
  public static Offset<global::MyGame.Example.TypeAliases> EndTypeAliases(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<global::MyGame.Example.TypeAliases>(o);
  }
  ...
  public static Offset<global::MyGame.Example.TypeAliases> Pack(FlatBufferBuilder builder, TypeAliasesT _o) {
    if (_o == null) return default(Offset<global::MyGame.Example.TypeAliases>);
