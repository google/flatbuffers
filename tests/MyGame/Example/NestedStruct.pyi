...
class NestedStructT(object):
  ...
  d: typing.List[int]
  def __init__(self, a: typing.List[int] | None = ..., b: typing.Literal[TestEnum.A, TestEnum.B, TestEnum.C] = ..., c: typing.List[typing.Literal[TestEnum.A, TestEnum.B, TestEnum.C]] | None = ..., d: typing.List[int] | None = ...) -> None: ...
  @classmethod
