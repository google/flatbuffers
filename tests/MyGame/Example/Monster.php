...
/// multiline too
    ...
    public static function createMonster(FlatBufferBuilder $builder, $pos, $mana, $hp, $name, $inventory, $color, $test_type, $test, $test4, $testarrayofstring, $testarrayoftables, $enemy, $testnestedflatbuffer, $testempty, $testbool, $testhashs32_fnv1, $testhashu32_fnv1, $testhashs64_fnv1, $testhashu64_fnv1, $testhashs32_fnv1a, $testhashu32_fnv1a, $testhashs64_fnv1a, $testhashu64_fnv1a, $testarrayofbools, $testf, $testf2, $testf3, $testarrayofstring2, $testarrayofsortedstruct, $flex, $test5, $vector_of_longs, $vector_of_doubles, $parent_namespace_test, $vector_of_referrables, $single_weak_reference, $vector_of_weak_references, $vector_of_strong_referrables, $co_owning_reference, $vector_of_co_owning_references, $non_owning_reference, $vector_of_non_owning_references, $any_unique_type, $any_unique, $any_ambiguous_type, $any_ambiguous, $vector_of_enums, $vec_of_structs_with_max, $vec_of_strings_with_max, $vec_of_referrables_with_max, $vec_of_strong_referrables_with_max, $vec_of_co_owning_references_with_max, $vec_of_non_owning_references_with_max, $vec_of_enums_with_max, $string_with_max)
    {
        ...
        self::addStringWithMax($builder, $string_with_max);
        $o = $builder->endObject();
     ...
     * @return void
     */
    public static function addStringWithMax(FlatBufferBuilder $builder, $stringWithMax)
    {
        $builder->addOffsetX(55, $stringWithMax, 0);
    }
