...
class Monster extends Table
{
     ...
     * @returnVectorOffset
     */
    public function getVectorOfParentNamespaceTest($j)
    {
        $o = $this->__offset(102);
        $obj = new InParentNamespace();
        return $o != 0 ? $obj->init($this->__indirect($this->__vector($o) + $j * 4), $this->bb) : null;
     ...
     * @return int
     */
    public function getVectorOfParentNamespaceTestLength()
    {
        $o = $this->__offset(102);
        return $o != 0 ? $this->__vector_len($o) : 0;
    }
     ...
     * @return Monster
     */
    public static function createMonster(FlatBufferBuilder $builder, $pos, $mana, $hp, $name, $inventory, $color, $test_type, $test, $test4, $testarrayofstring, $testarrayoftables, $enemy, $testnestedflatbuffer, $testempty, $testbool, $testhashs32_fnv1, $testhashu32_fnv1, $testhashs64_fnv1, $testhashu64_fnv1, $testhashs32_fnv1a, $testhashu32_fnv1a, $testhashs64_fnv1a, $testhashu64_fnv1a, $testarrayofbools, $testf, $testf2, $testf3, $testarrayofstring2, $testarrayofsortedstruct, $flex, $test5, $vector_of_longs, $vector_of_doubles, $parent_namespace_test, $vector_of_referrables, $single_weak_reference, $vector_of_weak_references, $vector_of_strong_referrables, $co_owning_reference, $vector_of_co_owning_references, $non_owning_reference, $vector_of_non_owning_references, $any_unique_type, $any_unique, $any_ambiguous_type, $any_ambiguous, $vector_of_enums, $signed_enum, $vector_of_parent_namespace_test)
    {
        $builder->startObject(50);
        ...
        self::addVectorOfParentNamespaceTest($builder, $vector_of_parent_namespace_test);
        $o = $builder->endObject();
     ...
     * @return void
     */
    public static function addVectorOfParentNamespaceTest(FlatBufferBuilder $builder, $vectorOfParentNamespaceTest)
    {
        $builder->addOffsetX(49, $vectorOfParentNamespaceTest, 0);
    }
     ...
     * @return int vector offset
     */
    public static function createVectorOfParentNamespaceTestVector(FlatBufferBuilder $builder, array $data)
    {
        $builder->startVector(4, count($data), 4);
        for ($i = count($data) - 1; $i >= 0; $i--) {
            $builder->putOffset($data[$i]);
     ...
     * @return void
     */
    public static function startVectorOfParentNamespaceTestVector(FlatBufferBuilder $builder, $numElems)
    {
        $builder->startVector(4, $numElems, 4);
    }
