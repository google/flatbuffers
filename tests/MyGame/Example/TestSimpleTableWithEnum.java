...
public final class TestSimpleTableWithEnum extends Table {
  ...
  public static TestSimpleTableWithEnum getSizePrefixedRootAsTestSimpleTableWithEnum(ByteBuffer _bb, TestSimpleTableWithEnum obj) { ByteBuffer __bb = _bb.slice(); __bb.position(Constants.SIZE_PREFIX_LENGTH); return getRootAsTestSimpleTableWithEnum(__bb, obj); }
