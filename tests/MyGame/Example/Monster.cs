...
public sealed class Monster : Table {
  ...
  public static VectorOffset CreateInventoryVector(FlatBufferBuilder builder, System.Collections.Generic.IList<byte> data) { builder.StartVector(1, data.Count, 1); for (int i = data.Count - 1; i >= 0; i--) builder.AddByte(data[i]); return builder.EndVector(); }
  ...
  public static VectorOffset CreateTestarrayofstringVector(FlatBufferBuilder builder, System.Collections.Generic.IList<StringOffset> data) { builder.StartVector(4, data.Count, 4); for (int i = data.Count - 1; i >= 0; i--) builder.AddOffset(data[i].Value); return builder.EndVector(); }
  ...
  public static VectorOffset CreateTestarrayoftablesVector(FlatBufferBuilder builder, System.Collections.Generic.IList<Offset<Monster>> data) { builder.StartVector(4, data.Count, 4); for (int i = data.Count - 1; i >= 0; i--) builder.AddOffset(data[i].Value); return builder.EndVector(); }
  ...
  public static VectorOffset CreateTestnestedflatbufferVector(FlatBufferBuilder builder, System.Collections.Generic.IList<byte> data) { builder.StartVector(1, data.Count, 1); for (int i = data.Count - 1; i >= 0; i--) builder.AddByte(data[i]); return builder.EndVector(); }
