...
bool VerifyUnion(::flatbuffers::VerifierTemplate<B>& verifier, const void* obj,
                 Union type);
template <bool B = false>
...
template <bool B>
inline bool VerifyUnion(::flatbuffers::VerifierTemplate<B>& verifier,
                        const void* obj, Union type) {
  switch (type) {
    case Union::NONE: {
      return true;
    }
...
template <bool B = false>
inline bool VerifyRootBuffer(::flatbuffers::VerifierTemplate<B>& verifier) {
...
inline bool VerifySizePrefixedRootBuffer(
    ::flatbuffers::VerifierTemplate<B>& verifier) {
  return verifier.template VerifySizePrefixedBuffer<Evolution::V2::Root>(
      nullptr);
}
