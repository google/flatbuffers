...
fn test_buffer_string_same_type_succeeds() {
    ...
    assert_eq!(value, Some("MyMonster"));
}
...
fn test_buffer_table_same_type_succeeds() {
    ...
    assert_eq!(nested_table_id, Some("Fred"));
}
