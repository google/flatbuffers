...
impl<'a> MoreDefaults<'a> {
    ...
    #[inline]
    pub fn abcs(&self) -> ::flatbuffers::Vector<'a, super::ABC> {
        // Safety:
        // Created from valid Table for this object
        // which contains a valid value in this slot
        unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<::flatbuffers::Vector<'a, super::ABC>>>(MoreDefaults::VT_ABCS, Some(Default::default())).unwrap()}
    }
...
impl ::flatbuffers::Verifiable for MoreDefaults<'_> {
    ...
    fn run_verifier(
        ...
        v.visit_table(pos)?
            ...
            .visit_field::<::flatbuffers::ForwardsUOffset<::flatbuffers::Vector<'_, super::ABC>>>("abcs", Self::VT_ABCS, false)?
...
pub struct MoreDefaultsArgs<'a> {
    ...
    pub abcs: Option<::flatbuffers::WIPOffset<::flatbuffers::Vector<'a, super::ABC>>>,
...
impl<'a: 'b, 'b, A: ::flatbuffers::Allocator + 'a> MoreDefaultsBuilder<'a, 'b, A> {
    ...
    #[inline]
    pub fn add_abcs(&mut self, abcs: ::flatbuffers::WIPOffset<::flatbuffers::Vector<'b , super::ABC>>) {
...
pub struct MoreDefaultsT {
    ...
    pub abcs: alloc::vec::Vec<super::ABC>,
