...
public struct MoreDefaults: FlatBufferObject, Verifiable, ObjectAPIPacker {
  ...
  public var intsPointer: UnsafeBufferPointer<Int32>? { return _accessor.getBufferPointer(at: VTOFFSET.ints.v) }
  ...
  public var floatsPointer: UnsafeBufferPointer<Float32>? { return _accessor.getBufferPointer(at: VTOFFSET.floats.v) }
  ...
  public var boolsPointer: UnsafeBufferPointer<Bool>? { return _accessor.getBufferPointer(at: VTOFFSET.bools.v) }
