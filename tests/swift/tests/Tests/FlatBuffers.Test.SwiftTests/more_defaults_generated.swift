...
public struct MoreDefaults: FlatBufferObject, Verifiable, ObjectAPIPacker {
  ...
  public var intsAsBuffer: UnsafeBufferPointer<Int32>? { return _accessor.getBufferPointer(at: VTOFFSET.ints.v) }
  ...
  public var floatsAsBuffer: UnsafeBufferPointer<Float32>? { return _accessor.getBufferPointer(at: VTOFFSET.floats.v) }
  ...
  public var boolsAsBuffer: UnsafeBufferPointer<Bool>? { return _accessor.getBufferPointer(at: VTOFFSET.bools.v) }
