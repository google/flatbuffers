...
public struct Swift_Tests_Vectors: FlatBufferObject, Verifiable {
  ...
  public var none_Pointer: UnsafeBufferPointer<UInt64>? { return _accessor.getBufferPointer(at: VTOFFSET.none_.v) }
  ...
  public var emptyPointer: UnsafeBufferPointer<UInt64>? { return _accessor.getBufferPointer(at: VTOFFSET.empty.v) }
  ...
  public var arrayPointer: UnsafeBufferPointer<UInt64>? { return _accessor.getBufferPointer(at: VTOFFSET.array.v) }
