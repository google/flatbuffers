...
public struct Swift_Tests_Vectors: FlatBufferObject, Verifiable {
  ...
  public var none_AsBuffer: UnsafeBufferPointer<UInt64>? { return _accessor.getBufferPointer(at: VTOFFSET.none_.v) }
  ...
  public var emptyAsBuffer: UnsafeBufferPointer<UInt64>? { return _accessor.getBufferPointer(at: VTOFFSET.empty.v) }
  ...
  public var arrayAsBuffer: UnsafeBufferPointer<UInt64>? { return _accessor.getBufferPointer(at: VTOFFSET.array.v) }
