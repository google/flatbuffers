...
impl<'a> TableB<'a> {
    ...
    #[inline]
    pub fn a(&self) -> Option<crate::TableA<'a>> {
        // Safety:
        // Created from valid Table for this object
        // which contains a valid value in this slot
        unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<crate::TableA>>(TableB::VT_A, None)}
    }
}
...
impl ::flatbuffers::Verifiable for TableB<'_> {
    ...
    fn run_verifier(
        ...
        v.visit_table(pos)?
            .visit_field::<::flatbuffers::ForwardsUOffset<crate::TableA>>("a", Self::VT_A, false)?
            .finish();
        Ok(())
    }
}
...
pub struct TableBArgs<'a> {
    pub a: Option<::flatbuffers::WIPOffset<crate::TableA<'a>>>,
}
...
impl<'a: 'b, 'b, A: ::flatbuffers::Allocator + 'a> TableBBuilder<'a, 'b, A> {
    #[inline]
    pub fn add_a(&mut self, a: ::flatbuffers::WIPOffset<crate::TableA<'b >>) {
        self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<crate::TableA>>(TableB::VT_A, a);
    }
...
pub struct TableBT {
    pub a: Option<alloc::boxed::Box<crate::TableAT>>,
}
