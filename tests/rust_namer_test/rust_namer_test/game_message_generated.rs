...
pub enum GameMessageT {
    NONE,
    PlayerStatEvent(alloc::boxed::Box<super::PlayerStatEventT>),
    PlayerSpectate(alloc::boxed::Box<super::PlayerSpectateT>),
    PlayerInputChange(alloc::boxed::Box<super::PlayerInputChangeT>),
}
...
impl GameMessageT {
    ...
    /// If the union variant matches, return the owned super::PlayerStatEventT, setting the union to NONE.
    pub fn take_player_stat_event(&mut self) -> Option<alloc::boxed::Box<super::PlayerStatEventT>> {
    ...
    /// If the union variant matches, return a reference to the super::PlayerStatEventT.
    pub fn as_player_stat_event(&self) -> Option<&super::PlayerStatEventT> {
        if let Self::PlayerStatEvent(v) = self { Some(v.as_ref()) } else { None }
    }

    /// If the union variant matches, return a mutable reference to the super::PlayerStatEventT.
    pub fn as_player_stat_event_mut(&mut self) -> Option<&mut super::PlayerStatEventT> {
        if let Self::PlayerStatEvent(v) = self { Some(v.as_mut()) } else { None }
    }

    /// If the union variant matches, return the owned super::PlayerSpectateT, setting the union to NONE.
    pub fn take_player_spectate(&mut self) -> Option<alloc::boxed::Box<super::PlayerSpectateT>> {
    ...
    /// If the union variant matches, return a reference to the super::PlayerSpectateT.
    pub fn as_player_spectate(&self) -> Option<&super::PlayerSpectateT> {
        if let Self::PlayerSpectate(v) = self { Some(v.as_ref()) } else { None }
    }

    /// If the union variant matches, return a mutable reference to the super::PlayerSpectateT.
    pub fn as_player_spectate_mut(&mut self) -> Option<&mut super::PlayerSpectateT> {
        if let Self::PlayerSpectate(v) = self { Some(v.as_mut()) } else { None }
    }

    /// If the union variant matches, return the owned super::PlayerInputChangeT, setting the union to NONE.
    pub fn take_player_input_change(&mut self) -> Option<alloc::boxed::Box<super::PlayerInputChangeT>> {
    ...
    /// If the union variant matches, return a reference to the super::PlayerInputChangeT.
    pub fn as_player_input_change(&self) -> Option<&super::PlayerInputChangeT> {
        if let Self::PlayerInputChange(v) = self { Some(v.as_ref()) } else { None }
    }

    /// If the union variant matches, return a mutable reference to the super::PlayerInputChangeT.
    pub fn as_player_input_change_mut(&mut self) -> Option<&mut super::PlayerInputChangeT> {
