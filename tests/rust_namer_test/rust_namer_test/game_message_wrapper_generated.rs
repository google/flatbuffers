...
impl<'a> GameMessageWrapper<'a> {
    ...
    pub fn Message_type(&self) -> GameMessage {
        ...
        unsafe { self.tab.get::<GameMessage>(GameMessageWrapper::VT_MESSAGE_TYPE, Some(GameMessage::NONE)).unwrap()}
    }
    ...
    pub fn Message(&self) -> Option<::flatbuffers::Table<'a>> {
        ...
        // Created from valid Table for this object
        // which contains a valid value in this slot
        unsafe { self.tab.get::<::flatbuffers::ForwardsUOffset<::flatbuffers::Table<'a>>>(GameMessageWrapper::VT_MESSAGE, None)}
    }
...
impl GameMessageWrapperT {
    ...
    pub fn pack<'b, A: ::flatbuffers::Allocator + 'b>(
        ...
        debug_assert!(Message.is_some() || Message_type == GameMessage::NONE, "Union discriminant does not match packed value");
        GameMessageWrapper::create(fbb, &GameMessageWrapperArgs{
            Message_type,
            Message,
        })
    }
