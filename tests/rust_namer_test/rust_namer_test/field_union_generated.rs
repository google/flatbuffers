...
pub enum FieldUnionT {
    NONE,
    F(alloc::boxed::Box<super::FieldTableT>),
}
...
impl FieldUnionT {
    ...
    /// If the union variant matches, return the owned super::FieldTableT, setting the union to NONE.
    pub fn take_f(&mut self) -> Option<alloc::boxed::Box<super::FieldTableT>> {
    ...
    /// If the union variant matches, return a reference to the super::FieldTableT.
    pub fn as_f(&self) -> Option<&super::FieldTableT> {
        if let Self::F(v) = self { Some(v.as_ref()) } else { None }
    }

    /// If the union variant matches, return a mutable reference to the super::FieldTableT.
