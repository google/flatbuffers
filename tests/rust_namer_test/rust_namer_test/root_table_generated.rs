...
impl<'a> RootTable<'a> {
    ...
    pub fn field42_type(&self) -> FieldUnion {
        ...
        unsafe { self.tab.get::<FieldUnion>(RootTable::VT_FIELD42_TYPE, Some(FieldUnion::NONE)).unwrap()}
    }
    ...
    pub fn field42(&self) -> Option<::flatbuffers::Table<'a>> {
        ...
        // Created from valid Table for this object
        // which contains a valid value in this slot
        unsafe { self.tab.get::<::flatbuffers::ForwardsUOffset<::flatbuffers::Table<'a>>>(RootTable::VT_FIELD42, None)}
    }
...
impl RootTableT {
    ...
    pub fn pack<'b, A: ::flatbuffers::Allocator + 'b>(
        ...
        debug_assert!(field42.is_some() || field42_type == FieldUnion::NONE, "Union discriminant does not match packed value");
        RootTable::create(fbb, &RootTableArgs{
            field42_type,
            field42,
        })
    }
