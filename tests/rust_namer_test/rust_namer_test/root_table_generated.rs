...
impl<'a> RootTable<'a> {
    ...
    pub fn unpack(&self) -> RootTableT {
        let field42 = match self.field42_type() {
            super::FieldUnion::NONE => super::FieldUnionT::NONE,
            super::FieldUnion::f => super::FieldUnionT::F(alloc::boxed::Box::new(
                self.field42_as_f()
                    .expect("Invalid union table, expected `super::FieldUnion::f`.")
                    .unpack()
            )),
            _ => super::FieldUnionT::NONE,
        };
        RootTableT {
            field42,
        }
    ...
    #[inline]
    pub fn field42_type(&self) -> super::FieldUnion {
        // Safety:
        // Created from valid Table for this object
        // which contains a valid value in this slot
        unsafe { self._tab.get::<super::FieldUnion>(RootTable::VT_FIELD42_TYPE, Some(super::FieldUnion::NONE)).unwrap()}
    }
    ...
    pub fn field42_as_f(&self) -> Option<super::FieldTable<'a>> {
        if self.field42_type() == super::FieldUnion::f {
            self.field42().map(|t| {
                // Safety:
                // Created from a valid Table for this object
                // Which contains a valid union in this slot
                unsafe { super::FieldTable::init_from_table(t) }
            })
        } else {
            None
        }
...
impl ::flatbuffers::Verifiable for RootTable<'_> {
    ...
    fn run_verifier(
        ...
        v.visit_table(pos)?
            .visit_union::<super::FieldUnion, _>("field42_type", Self::VT_FIELD42_TYPE, "field42", Self::VT_FIELD42, false, |key, v, pos| {
                match key {
                    super::FieldUnion::f => v.verify_union_variant::<::flatbuffers::ForwardsUOffset<super::FieldTable>>("super::FieldUnion::f", pos),
                    _ => Ok(()),
                }
            })?
            .finish();
...
pub struct RootTableArgs {
    pub field42_type: super::FieldUnion,
...
impl<'a> Default for RootTableArgs {
    ...
    fn default() -> Self {
        RootTableArgs {
            field42_type: super::FieldUnion::NONE,
            field42: None,
        }
    }
}
...
impl<'a: 'b, 'b, A: ::flatbuffers::Allocator + 'a> RootTableBuilder<'a, 'b, A> {
    #[inline]
    pub fn add_field42_type(&mut self, field42_type: super::FieldUnion) {
        self.fbb_.push_slot::<super::FieldUnion>(RootTable::VT_FIELD42_TYPE, field42_type, super::FieldUnion::NONE);
    }
...
pub struct RootTableT {
    pub field42: super::FieldUnionT,
}

impl Default for RootTableT {
    fn default() -> Self {
        Self {
            field42: super::FieldUnionT::NONE,
        }
    }
}
