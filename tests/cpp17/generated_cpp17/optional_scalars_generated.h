...
struct ScalarStuff FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  ...
  static constexpr auto getter_for() {
         if constexpr (Index == 0) return &ScalarStuff::just_i8;
    else if constexpr (Index == 1) return &ScalarStuff::maybe_i8;
    else if constexpr (Index == 2) return &ScalarStuff::default_i8;
    else if constexpr (Index == 3) return &ScalarStuff::just_u8;
    else if constexpr (Index == 4) return &ScalarStuff::maybe_u8;
    else if constexpr (Index == 5) return &ScalarStuff::default_u8;
    else if constexpr (Index == 6) return &ScalarStuff::just_i16;
    else if constexpr (Index == 7) return &ScalarStuff::maybe_i16;
    else if constexpr (Index == 8) return &ScalarStuff::default_i16;
    else if constexpr (Index == 9) return &ScalarStuff::just_u16;
    else if constexpr (Index == 10) return &ScalarStuff::maybe_u16;
    else if constexpr (Index == 11) return &ScalarStuff::default_u16;
    else if constexpr (Index == 12) return &ScalarStuff::just_i32;
    else if constexpr (Index == 13) return &ScalarStuff::maybe_i32;
    else if constexpr (Index == 14) return &ScalarStuff::default_i32;
    else if constexpr (Index == 15) return &ScalarStuff::just_u32;
    else if constexpr (Index == 16) return &ScalarStuff::maybe_u32;
    else if constexpr (Index == 17) return &ScalarStuff::default_u32;
    else if constexpr (Index == 18) return &ScalarStuff::just_i64;
    else if constexpr (Index == 19) return &ScalarStuff::maybe_i64;
    else if constexpr (Index == 20) return &ScalarStuff::default_i64;
    else if constexpr (Index == 21) return &ScalarStuff::just_u64;
    else if constexpr (Index == 22) return &ScalarStuff::maybe_u64;
    else if constexpr (Index == 23) return &ScalarStuff::default_u64;
    else if constexpr (Index == 24) return &ScalarStuff::just_f32;
    else if constexpr (Index == 25) return &ScalarStuff::maybe_f32;
    else if constexpr (Index == 26) return &ScalarStuff::default_f32;
    else if constexpr (Index == 27) return &ScalarStuff::just_f64;
    else if constexpr (Index == 28) return &ScalarStuff::maybe_f64;
    else if constexpr (Index == 29) return &ScalarStuff::default_f64;
    else if constexpr (Index == 30) return &ScalarStuff::just_bool;
    else if constexpr (Index == 31) return &ScalarStuff::maybe_bool;
    else if constexpr (Index == 32) return &ScalarStuff::default_bool;
    else if constexpr (Index == 33) return &ScalarStuff::just_enum;
    else if constexpr (Index == 34) return &ScalarStuff::maybe_enum;
    else if constexpr (Index == 35) return &ScalarStuff::default_enum;
