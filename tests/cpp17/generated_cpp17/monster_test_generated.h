...
struct MonsterT : public flatbuffers::NativeTable {
  ...
  std::vector<std::unique_ptr<MyGame::InParentNamespaceT>> vector_of_parent_namespace_test;
  MonsterT()
      : mana(150),
        hp(100),
...
if (_resolver) (*_resolver)(reinterpret_cast<void **>(&_o->vector_of_non_owning_references[_i]), static_cast<flatbuffers::hash_value_t>(_e->Get(_i))); else _o->vector_of_non_owning_references[_i] = nullptr; } } }
  ...
  { auto _e = vector_of_parent_namespace_test(); if (_e) { _o->vector_of_parent_namespace_test.resize(_e->size()); for (flatbuffers::uoffset_t _i = 0; _i < _e->size(); _i++) { _o->vector_of_parent_namespace_test[_i] = std::unique_ptr<MyGame::InParentNamespaceT>(_e->Get(_i)->UnPack(_resolver)); } } }
}
