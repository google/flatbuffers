...
bool VerifyCharacter(::flatbuffers::VerifierTemplate<B>& verifier,
...
template <bool B = false>
bool VerifyGadget(::flatbuffers::VerifierTemplate<B>& verifier, const void* obj,
                  Gadget type);
template <bool B = false>
...
struct Movie FLATBUFFERS_FINAL_CLASS : private ::flatbuffers::Table {
  ...
  Attacker* mutable_main_character_as_MuLan() {
    return main_character_type() == Character_MuLan
               ? static_cast<Attacker*>(mutable_main_character())
               : nullptr;
  }
  Rapunzel* mutable_main_character_as_Rapunzel() {
    return main_character_type() == Character_Rapunzel
               ? static_cast<Rapunzel*>(mutable_main_character())
               : nullptr;
  }
  BookReader* mutable_main_character_as_Belle() {
    return main_character_type() == Character_Belle
               ? static_cast<BookReader*>(mutable_main_character())
               : nullptr;
  }
  ...
  ::flatbuffers::String* mutable_main_character_as_Other() {
    return main_character_type() == Character_Other
               ? static_cast<::flatbuffers::String*>(mutable_main_character())
               : nullptr;
  }
...
template <bool B>
inline bool VerifyCharacter(::flatbuffers::VerifierTemplate<B>& verifier,
                            const void* obj, Character type) {
  switch (type) {
    case Character_NONE: {
      return true;
    ...
    case Character_Rapunzel: {
      return verifier.template VerifyField<Rapunzel>(
          static_cast<const uint8_t*>(obj), 0, 4);
    }
    case Character_Belle: {
      return verifier.template VerifyField<BookReader>(
          static_cast<const uint8_t*>(obj), 0, 4);
    }
    case Character_BookFan: {
      return verifier.template VerifyField<BookReader>(
...
template <bool B>
inline bool VerifyGadget(::flatbuffers::VerifierTemplate<B>& verifier,
  ...
  switch (type) {
    ...
    case Gadget_FallingTub: {
      return verifier.template VerifyField<FallingTub>(
          static_cast<const uint8_t*>(obj), 0, 4);
    }
    case Gadget_HandFan: {
...
template <bool B = false>
inline bool VerifyMovieBuffer(::flatbuffers::VerifierTemplate<B>& verifier) {
