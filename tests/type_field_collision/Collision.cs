...
namespace type_field_collision
{
...
public struct Collision : IFlatbufferObject
{
  ...
  public static Offset<type_field_collision.Collision> CreateCollision(FlatBufferBuilder builder,
      int collision = 0) {
  ...
  public static Offset<type_field_collision.Collision> EndCollision(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<type_field_collision.Collision>(o);
  }
  public static void FinishCollisionBuffer(FlatBufferBuilder builder, Offset<type_field_collision.Collision> offset) { builder.Finish(offset.Value); }
  public static void FinishSizePrefixedCollisionBuffer(FlatBufferBuilder builder, Offset<type_field_collision.Collision> offset) { builder.FinishSizePrefixed(offset.Value); }
  ...
  public static Offset<type_field_collision.Collision> Pack(FlatBufferBuilder builder, CollisionT _o) {
    if (_o == null) return default(Offset<type_field_collision.Collision>);
