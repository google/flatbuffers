...
func TestAll(t *testing.T) {
	...
	// generated Go code:
	CheckReadBuffer(generated, off, false, false, t.Fatalf)
	...
	CheckReadBuffer(generated, off, false, true, t.Fatalf)
	CheckMutateBuffer(generated, off, false, t.Fatalf)
	CheckObjectAPI(generated, off, false, t.Fatalf)
	...
	CheckReadBuffer(monsterDataCpp, 0, false, true, t.Fatalf)
	...
	if javaData != "" {
		...
		CheckReadBuffer(monsterDataJava, 0, false, true, t.Fatalf)
...
func CheckReadBuffer(buf []byte, offset flatbuffers.UOffsetT, sizePrefix bool, fileIdentifier bool, fail func(string, ...interface{})) {

	if fileIdentifier {
		offsetBuf := buf[offset:]
		if sizePrefix {
			if !example.SizePrefixedVerifyMonster(offsetBuf) {
				fail("SizePrefixedVerifyMonster failed - invalid buffer data")
			}
		} else {
			if !example.VerifyMonster(offsetBuf) {
				fail("VerifyMonster failed - invalid buffer data")
			}
		}
	}
...
func CheckSizePrefixedBuffer(fail func(string, ...interface{})) {
	...
	CheckReadBuffer(generated, off, true, false, fail)
	...
	// Check that the buffer can be used as expected
	CheckReadBuffer(generated, off, true, true, fail)
	CheckMutateBuffer(generated, off, true, fail)
	CheckObjectAPI(generated, off, true, fail)
