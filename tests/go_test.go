...
func TestAll(t *testing.T) {
	...
	// returning errors:
	generated, off := CheckGeneratedBuild(t.Fatalf, false)
...
func CheckGeneratedBuild(fail func(string, ...interface{}), sizePrefix bool) ([]byte, flatbuffers.UOffsetT) {
	b := flatbuffers.NewBuilder(0)
	str := b.CreateString("MyMonster")
...
func BenchmarkParseGold(b *testing.B) {
	buf, offset := CheckGeneratedBuild(b.Fatalf, false)
	monster := example.GetRootAsMonster(buf, offset)
