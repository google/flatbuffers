...
import { Monster as MyGame_Example2_Monster, MonsterT as MyGame_Example2_MonsterT } from '../../MyGame/Example2/Monster.js';
import { Ability, AbilityT } from '../../MyGame/Example/Ability.js';
import { Any, unionToAny, unionListToAny } from '../../MyGame/Example/Any.js';
import { AnyAmbiguousAliases, unionToAnyAmbiguousAliases, unionListToAnyAmbiguousAliases } from '../../MyGame/Example/AnyAmbiguousAliases.js';
import { AnyUniqueAliases, unionToAnyUniqueAliases, unionListToAnyUniqueAliases } from '../../MyGame/Example/AnyUniqueAliases.js';
...
import { TestSimpleTableWithEnum, TestSimpleTableWithEnumT } from '../../MyGame/Example/TestSimpleTableWithEnum.js';
...
static add_test_type(builder:flatbuffers.Builder, test_type:Any) {
...
static add_testhashs32_fnv1(builder:flatbuffers.Builder, testhashs32_fnv1:number) {
  builder.addFieldInt32(16, testhashs32_fnv1, 0);
}

static add_testhashu32_fnv1(builder:flatbuffers.Builder, testhashu32_fnv1:number) {
  builder.addFieldInt32(17, testhashu32_fnv1, 0);
}

static add_testhashs64_fnv1(builder:flatbuffers.Builder, testhashs64_fnv1:bigint) {
  builder.addFieldInt64(18, testhashs64_fnv1, BigInt('0'));
}

static add_testhashu64_fnv1(builder:flatbuffers.Builder, testhashu64_fnv1:bigint) {
  builder.addFieldInt64(19, testhashu64_fnv1, BigInt('0'));
}

static add_testhashs32_fnv1a(builder:flatbuffers.Builder, testhashs32_fnv1a:number) {
  builder.addFieldInt32(20, testhashs32_fnv1a, 0);
}

static add_testhashu32_fnv1a(builder:flatbuffers.Builder, testhashu32_fnv1a:number) {
  builder.addFieldInt32(21, testhashu32_fnv1a, 0);
}

static add_testhashs64_fnv1a(builder:flatbuffers.Builder, testhashs64_fnv1a:bigint) {
  builder.addFieldInt64(22, testhashs64_fnv1a, BigInt('0'));
}

static add_testhashu64_fnv1a(builder:flatbuffers.Builder, testhashu64_fnv1a:bigint) {
...
static add_vector_of_longs(builder:flatbuffers.Builder, vector_of_longsOffset:flatbuffers.Offset) {
...
static add_vector_of_doubles(builder:flatbuffers.Builder, vector_of_doublesOffset:flatbuffers.Offset) {
...
static add_parent_namespace_test(builder:flatbuffers.Builder, parent_namespace_testOffset:flatbuffers.Offset) {
  builder.addFieldOffset(34, parent_namespace_testOffset, 0);
}

static add_vector_of_referrables(builder:flatbuffers.Builder, vector_of_referrablesOffset:flatbuffers.Offset) {
...
static add_single_weak_reference(builder:flatbuffers.Builder, single_weak_reference:bigint) {
  builder.addFieldInt64(36, single_weak_reference, BigInt('0'));
}

static add_vector_of_weak_references(builder:flatbuffers.Builder, vector_of_weak_referencesOffset:flatbuffers.Offset) {
...
static add_vector_of_strong_referrables(builder:flatbuffers.Builder, vector_of_strong_referrablesOffset:flatbuffers.Offset) {
...
static add_co_owning_reference(builder:flatbuffers.Builder, co_owning_reference:bigint) {
  builder.addFieldInt64(39, co_owning_reference, BigInt('0'));
}

static add_vector_of_co_owning_references(builder:flatbuffers.Builder, vector_of_co_owning_referencesOffset:flatbuffers.Offset) {
...
static add_non_owning_reference(builder:flatbuffers.Builder, non_owning_reference:bigint) {
  builder.addFieldInt64(41, non_owning_reference, BigInt('0'));
}

static add_vector_of_non_owning_references(builder:flatbuffers.Builder, vector_of_non_owning_referencesOffset:flatbuffers.Offset) {
...
static add_any_unique_type(builder:flatbuffers.Builder, any_unique_type:AnyUniqueAliases) {
  builder.addFieldInt8(43, any_unique_type, AnyUniqueAliases.NONE);
}

static add_any_unique(builder:flatbuffers.Builder, any_uniqueOffset:flatbuffers.Offset) {
  builder.addFieldOffset(44, any_uniqueOffset, 0);
}

static add_any_ambiguous_type(builder:flatbuffers.Builder, any_ambiguous_type:AnyAmbiguousAliases) {
  builder.addFieldInt8(45, any_ambiguous_type, AnyAmbiguousAliases.NONE);
}

static add_any_ambiguous(builder:flatbuffers.Builder, any_ambiguousOffset:flatbuffers.Offset) {
  builder.addFieldOffset(46, any_ambiguousOffset, 0);
}

static add_vector_of_enums(builder:flatbuffers.Builder, vector_of_enumsOffset:flatbuffers.Offset) {
...
static add_signed_enum(builder:flatbuffers.Builder, signed_enum:Race) {
...
static add_scalar_key_sorted_tables(builder:flatbuffers.Builder, scalar_key_sorted_tablesOffset:flatbuffers.Offset) {
...
static add_native_inline(builder:flatbuffers.Builder, native_inlineOffset:flatbuffers.Offset) {
  builder.addFieldStruct(51, native_inlineOffset, 0);
}

static add_long_enum_non_enum_default(builder:flatbuffers.Builder, long_enum_non_enum_default:bigint) {
  builder.addFieldInt64(52, long_enum_non_enum_default, BigInt('0'));
}

static add_long_enum_normal_default(builder:flatbuffers.Builder, long_enum_normal_default:bigint) {
  builder.addFieldInt64(53, long_enum_normal_default, BigInt('2'));
}

static add_nan_default(builder:flatbuffers.Builder, nan_default:number) {
  builder.addFieldFloat32(54, nan_default, NaN);
}

static add_inf_default(builder:flatbuffers.Builder, inf_default:number) {
  builder.addFieldFloat32(55, inf_default, Infinity);
}

static add_positive_inf_default(builder:flatbuffers.Builder, positive_inf_default:number) {
  builder.addFieldFloat32(56, positive_inf_default, Infinity);
}

static add_infinity_default(builder:flatbuffers.Builder, infinity_default:number) {
  builder.addFieldFloat32(57, infinity_default, Infinity);
}

static add_positive_infinity_default(builder:flatbuffers.Builder, positive_infinity_default:number) {
  builder.addFieldFloat32(58, positive_infinity_default, Infinity);
}

static add_negative_inf_default(builder:flatbuffers.Builder, negative_inf_default:number) {
  builder.addFieldFloat32(59, negative_inf_default, -Infinity);
}

static add_negative_infinity_default(builder:flatbuffers.Builder, negative_infinity_default:number) {
  builder.addFieldFloat32(60, negative_infinity_default, -Infinity);
}

static add_double_inf_default(builder:flatbuffers.Builder, double_inf_default:number) {
