...
impl<'a> flatbuffers::Follow<'a> for StringKey<'a> {
    type Inner = StringKey<'a>;
    #[inline]
    fn follow(buf: &'a [u8], loc: usize) -> Self::Inner {
        Self { _tab: flatbuffers::Table { buf, loc } }
    }
...
impl<'a> StringKey<'a> {
    ...
    pub fn create<'bldr: 'args, 'args: 'mut_bldr, 'mut_bldr>(
        _fbb: &'mut_bldr mut flatbuffers::FlatBufferBuilder<'bldr>,
        args: &'args StringKeyArgs<'args>) -> flatbuffers::WIPOffset<StringKey<'bldr>> {
      let mut builder = StringKeyBuilder::new(_fbb);
  ...
  #[inline]
  pub fn k(&self) -> &'a str {
    self._tab.get::<flatbuffers::ForwardsUOffset<&str>>(StringKey::VT_K, None).unwrap()
  }
  #[inline]
  pub fn key_compare_less_than(&self, o: &StringKey) ->  bool {
    self.k() < o.k()
  }
...
impl flatbuffers::Verifiable for StringKey<'_> {
  #[inline]
  fn run_verifier(
    v: &mut flatbuffers::Verifier, pos: usize
  ) -> Result<(), flatbuffers::InvalidFlatbuffer> {
    use self::flatbuffers::Verifiable;
    v.visit_table(pos)?
     .visit_field::<flatbuffers::ForwardsUOffset<&str>>(&"k", Self::VT_K, true)?
     .finish();
    Ok(())
  }
}
pub struct StringKeyArgs<'a> {
    pub k: Option<flatbuffers::WIPOffset<&'a str>>,
}
impl<'a> Default for StringKeyArgs<'a> {
    #[inline]
    fn default() -> Self {
        StringKeyArgs {
            k: None, // required field
        }
    }
}
pub struct StringKeyBuilder<'a: 'b, 'b> {
  fbb_: &'b mut flatbuffers::FlatBufferBuilder<'a>,
  start_: flatbuffers::WIPOffset<flatbuffers::TableUnfinishedWIPOffset>,
}
impl<'a: 'b, 'b> StringKeyBuilder<'a, 'b> {
  #[inline]
  pub fn add_k(&mut self, k: flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(StringKey::VT_K, k);
  }
  #[inline]
  pub fn new(_fbb: &'b mut flatbuffers::FlatBufferBuilder<'a>) -> StringKeyBuilder<'a, 'b> {
    let start = _fbb.start_table();
    StringKeyBuilder {
      fbb_: _fbb,
      start_: start,
  ...
  #[inline]
  pub fn finish(self) -> flatbuffers::WIPOffset<StringKey<'a>> {
    let o = self.fbb_.end_table(self.start_);
    self.fbb_.required(o, StringKey::VT_K,"k");
    flatbuffers::WIPOffset::new(o.value())
  }
}

impl std::fmt::Debug for StringKey<'_> {
  fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
    let mut ds = f.debug_struct("StringKey");
      ds.field("k", &self.k());
      ds.finish()
  }
}
