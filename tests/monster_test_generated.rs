...
impl<'a> Monster<'a> {
    ...
    pub fn create<'bldr: 'args, 'args: 'mut_bldr, 'mut_bldr>(
      ...
      if let Some(x) = args.string_with_max { builder.add_string_with_max(x); }
    ...
    pub const VT_STRING_WITH_MAX: flatbuffers::VOffsetT = 114;
  ...
  #[inline]
  pub fn string_with_max(&self) -> Option<&'a str> {
    self._tab.get::<flatbuffers::ForwardsUOffset<&str>>(Monster::VT_STRING_WITH_MAX, None)
  }
  #[inline]
...
pub struct MonsterArgs<'a> {
    ...
    pub string_with_max: Option<flatbuffers::WIPOffset<&'a  str>>,
}
...
impl<'a: 'b, 'b> MonsterBuilder<'a, 'b> {
  ...
  #[inline]
  pub fn add_string_with_max(&mut self, string_with_max: flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(Monster::VT_STRING_WITH_MAX, string_with_max);
  }
  #[inline]
  pub fn new(_fbb: &'b mut flatbuffers::FlatBufferBuilder<'a>) -> MonsterBuilder<'a, 'b> {
    let start = _fbb.start_table();
