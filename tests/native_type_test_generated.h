...
struct Matrix FLATBUFFERS_FINAL_CLASS : private ::flatbuffers::Table {
  ...
  int32_t columns() const { return GetField<int32_t>(VT_COLUMNS, 0); }
...
struct MatrixBuilder {
  ...
  explicit MatrixBuilder(::flatbuffers::FlatBufferBuilder& _fbb) : fbb_(_fbb) {
...
inline ::flatbuffers::Offset<Matrix> CreateMatrix(
    ::flatbuffers::FlatBufferBuilder& _fbb, int32_t rows = 0,
    int32_t columns = 0,
...
inline ::flatbuffers::Offset<Matrix> CreateMatrixDirect(
    ::flatbuffers::FlatBufferBuilder& _fbb, int32_t rows = 0,
    int32_t columns = 0, const std::vector<float>* values = nullptr) {
  auto values__ = values ? _fbb.CreateVector<float>(*values) : 0;
  return Geometry::CreateMatrix(_fbb, rows, columns, values__);
}
...
struct ApplicationData FLATBUFFERS_FINAL_CLASS : private ::flatbuffers::Table {
  ...
  const ::flatbuffers::Vector<::flatbuffers::Offset<Geometry::Matrix>>*
  matrices() const {
    return GetPointer<
        const ::flatbuffers::Vector<::flatbuffers::Offset<Geometry::Matrix>>*>(
        VT_MATRICES);
  }
  ::flatbuffers::Vector<::flatbuffers::Offset<Geometry::Matrix>>*
  mutable_matrices() {
    return GetPointer<
        ::flatbuffers::Vector<::flatbuffers::Offset<Geometry::Matrix>>*>(
        VT_MATRICES);
  ...
  bool Verify(::flatbuffers::VerifierTemplate<B>& verifier) const {
    return VerifyTableStart(verifier) && VerifyOffset(verifier, VT_VECTORS) &&
           ...
           verifier.VerifyVectorOfTables(matrices()) && verifier.EndTable();
  }
...
inline ::flatbuffers::Offset<ApplicationData> CreateApplicationDataDirect(
    ...
    const Geometry::Vector3D* position_inline = nullptr,
    ::flatbuffers::Offset<Geometry::Matrix> matrix = 0,
    const std::vector<::flatbuffers::Offset<Geometry::Matrix>>* matrices =
        nullptr) {
  auto vectors__ =
  ...
  auto vectors_alt__ =
      vectors_alt
          ...
          : 0;
  auto matrices__ =
      matrices ? _fbb.CreateVector<::flatbuffers::Offset<Geometry::Matrix>>(
                     *matrices)
               : 0;
  return Geometry::CreateApplicationData(_fbb, vectors__, vectors_alt__,
                                         position, position_inline, matrix,
                                         matrices__);
}
...
inline Native::Matrix* Matrix::UnPack(
...
inline bool operator==(const ApplicationDataT& lhs,
                       const ApplicationDataT& rhs) {
  return (lhs.vectors == rhs.vectors) && (lhs.vectors_alt == rhs.vectors_alt) &&
         ((lhs.position == rhs.position) ||
          (lhs.position && rhs.position && *lhs.position == *rhs.position)) &&
         (lhs.position_inline == rhs.position_inline) &&
         ((lhs.matrix == rhs.matrix) ||
          (lhs.matrix && rhs.matrix && *lhs.matrix == *rhs.matrix)) &&
         (lhs.matrices.size() == rhs.matrices.size() &&
          std::equal(lhs.matrices.cbegin(), lhs.matrices.cend(),
                     rhs.matrices.cbegin(),
                     [](std::unique_ptr<Native::Matrix> const& a,
                        std::unique_ptr<Native::Matrix> const& b) {
                       return (a == b) || (a && b && *a == *b);
                     }));
}
...
inline ApplicationDataT::ApplicationDataT(const ApplicationDataT& o)
  ...
  for (const auto& matrices_ : o.matrices) {
    matrices.emplace_back((matrices_) ? new Native::Matrix(*matrices_)
                                      : nullptr);
  }
}
...
inline void ApplicationData::UnPackTo(
  ...
  }
  {
    ...
    if (_e) {
      if (_o->matrix) {
        _e->UnPackTo(_o->matrix.get(), _resolver);
      } else {
        _o->matrix = std::unique_ptr<Native::Matrix>(_e->UnPack(_resolver));
      }
    } else if (_o->matrix) {
      _o->matrix.reset();
    }
  }
  {
    auto _e = matrices();
    if (_e) {
      _o->matrices.resize(_e->size());
      for (::flatbuffers::uoffset_t _i = 0; _i < _e->size(); _i++) {
        if (_o->matrices[_i]) {
          _e->Get(_i)->UnPackTo(_o->matrices[_i].get(), _resolver);
        } else {
          _o->matrices[_i] =
              std::unique_ptr<Native::Matrix>(_e->Get(_i)->UnPack(_resolver));
        }
      }
    } else {
      _o->matrices.resize(0);
    }
  }
}
...
inline ::flatbuffers::Offset<ApplicationData> ApplicationData::Pack(
  ...
  auto _matrix = _o->matrix
                     ? Geometry::CreateMatrix(_fbb, _o->matrix.get(), _rehasher)
                     : 0;
  auto _matrices =
      _o->matrices.size()
          ? _fbb.CreateVector<::flatbuffers::Offset<Geometry::Matrix>>(
                _o->matrices.size(),
                [](size_t i, _VectorArgs* __va) {
                  return Geometry::CreateMatrix(*__va->__fbb,
                                                __va->__o->matrices[i].get(),
                                                __va->__rehasher);
                },
                &_va)
          : 0;
  return Geometry::CreateApplicationData(_fbb, _vectors, _vectors_alt,
                                         ...
                                         &_position_inline, _matrix, _matrices);
}
...
inline const ::flatbuffers::TypeTable* MatrixTypeTable() {
  ...
  static const char* const names[] = {"rows", "columns", "values"};
  static const ::flatbuffers::TypeTable tt = {
...
inline const ::flatbuffers::TypeTable* ApplicationDataTypeTable() {
  static const ::flatbuffers::TypeCode type_codes[] = {
      ...
      {::flatbuffers::ET_SEQUENCE, 0, 2}, {::flatbuffers::ET_SEQUENCE, 1, 2}};
...
inline bool VerifySizePrefixedApplicationDataBuffer(
    ::flatbuffers::VerifierTemplate<B>& verifier) {
  return verifier.template VerifySizePrefixedBuffer<Geometry::ApplicationData>(
      nullptr);
}
