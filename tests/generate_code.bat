...
..\%buildtype%\flatc.exe --rust -I include_test -o include_test1 include_test/include_test1.fbs || goto FAIL
..\%buildtype%\flatc.exe --rust -I include_test -o include_test2 include_test/sub/include_test2.fbs || goto FAIL
