...
#ifndef FLATBUFFERS_GENERATED_NATIVETEST_TESTN_H_
#define FLATBUFFERS_GENERATED_NATIVETEST_TESTN_H_
...
inline const TestN::Foo *GetSizePrefixedFoo(const void *buf) {
  return flatbuffers::GetSizePrefixedRoot<TestN::Foo>(buf);
}

inline bool VerifyFooBuffer(
    flatbuffers::Verifier &verifier) {
  return verifier.VerifyBuffer<TestN::Foo>(nullptr);
}

inline bool VerifySizePrefixedFooBuffer(
    flatbuffers::Verifier &verifier) {
  return verifier.VerifySizePrefixedBuffer<TestN::Foo>(nullptr);
}

inline void FinishFooBuffer(
    flatbuffers::FlatBufferBuilder &fbb,
    flatbuffers::Offset<TestN::Foo> root) {
  fbb.Finish(root);
}
...
#endif  // FLATBUFFERS_GENERATED_NATIVETEST_TESTN_H_
