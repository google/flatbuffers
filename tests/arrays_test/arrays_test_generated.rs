...
pub mod my_game {
    ...
    pub mod example {
        ...
        impl<'a> NestedStruct {
            ...
            pub fn b(&self) -> TestEnum {
                let mut mem = ::core::mem::MaybeUninit::<
                    <TestEnum as ::flatbuffers::EndianScalar>::Scalar,
                >::uninit();
                // Safety:
                // Created from a valid Table for this object
        ...
        impl<'a> LargeArrayStruct {
            #[allow(clippy::too_many_arguments)]
            pub fn new(d: &[u8; 64], e: &[f32; 64], f: &[bool; 64]) -> Self {
        ...
        impl LargeArrayStructT {
            pub fn pack(&self) -> LargeArrayStruct {
                LargeArrayStruct::new(&self.d, &self.e, &self.f)
            }
        }
