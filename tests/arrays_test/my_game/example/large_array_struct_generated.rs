    ...
    unsafe fn push(&self, dst: &mut [u8], _written_len: usize) {
        let src = unsafe {
            ::core::slice::from_raw_parts(
                self as *const LargeArrayStruct as *const u8,
...
impl<'a> LargeArrayStruct {
    ...
    pub fn set_g(&mut self, x: &[NestedStruct; 64]) {
        ...
        // Which contains a valid array in this slot
        unsafe {
            ::core::ptr::copy(x.as_ptr() as *const u8, self.0.as_mut_ptr().add(384), 2048);
        }
    }
    ...
    pub fn set_h(&mut self, x: &[TestEnum; 64]) {
        ...
        // Which contains a valid array in this slot
        unsafe {
            ::core::ptr::copy(x.as_ptr() as *const u8, self.0.as_mut_ptr().add(2432), 64);
        }
    }
    ...
    pub fn unpack(&self) -> LargeArrayStructT {
        LargeArrayStructT {
            ...
            e: {
                let e = self.e();
                ::flatbuffers::array_init(|i| e.get(i))
            },
            f: self.f().into(),
            g: {
                let g = self.g();
                ::flatbuffers::array_init(|i| g.get(i).unpack())
            },
            h: self.h().into(),
        }
    }
