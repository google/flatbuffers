...
impl<'a> ArrayTable<'a> {
    ...
    #[inline]
    pub fn a(&self) -> Option<&'a super::ArrayStruct> {
        // Safety:
        // Created from valid Table for this object
        // which contains a valid value in this slot
        unsafe { self._tab.get::<super::ArrayStruct>(ArrayTable::VT_A, None)}
    }
}
...
impl ::flatbuffers::Verifiable for ArrayTable<'_> {
    ...
    fn run_verifier(
        ...
        v.visit_table(pos)?
            .visit_field::<super::ArrayStruct>("a", Self::VT_A, false)?
            .finish();
        Ok(())
    }
}
...
pub struct ArrayTableArgs<'a> {
    pub a: Option<&'a super::ArrayStruct>,
}
...
impl<'a: 'b, 'b, A: ::flatbuffers::Allocator + 'a> ArrayTableBuilder<'a, 'b, A> {
    #[inline]
    pub fn add_a(&mut self, a: &super::ArrayStruct) {
        self.fbb_.push_slot_always::<&super::ArrayStruct>(ArrayTable::VT_A, a);
    }
...
pub struct ArrayTableT {
    pub a: Option<super::ArrayStructT>,
}
