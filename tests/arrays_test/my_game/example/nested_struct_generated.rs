...
impl<'a> NestedStruct {
    ...
    pub fn b(&self) -> super::TestEnum {
        let mut mem = ::core::mem::MaybeUninit::<<super::TestEnum as ::flatbuffers::EndianScalar>::Scalar>::uninit();
        // Safety:
        // Created from a valid Table for this object
        ...
        ::flatbuffers::EndianScalar::from_little_endian(unsafe {
            ::core::ptr::copy_nonoverlapping(
                ...
                ::core::mem::size_of::<<super::TestEnum as ::flatbuffers::EndianScalar>::Scalar>(),
            );
            mem.assume_init()
        })
    }

    pub fn set_b(&mut self, x: super::TestEnum) {
    ...
    pub fn c(&'a self) -> ::flatbuffers::Array<'a, super::TestEnum, 2> {
        // Safety:
        // Created from a valid Table for this object
        // Which contains a valid array in this slot
        use ::flatbuffers::Follow;
    ...
    pub fn set_c(&mut self, x: &[super::TestEnum; 2]) {
        // Safety:
        // Created from a valid Table for this object
        // Which contains a valid array in this slot
        unsafe {
...
pub struct NestedStructT {
    pub a: [i32; 2],
    pub b: super::TestEnum,
    pub c: [super::TestEnum; 2],
    pub d: [i64; 2],
}
