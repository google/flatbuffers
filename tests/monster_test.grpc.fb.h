 ...
 public:
  ...
  class Stub final : public StubInterface {
   public:
    ...
    void async_Store(::grpc::ClientContext* context,
                     const flatbuffers::grpc::Message<Monster>& request,
                     flatbuffers::grpc::Message<Stat>* response,
    ...
    void async_Retrieve(
        ::grpc::ClientContext* context,
        const flatbuffers::grpc::Message<Stat>& request,
        ::grpc::ClientReadReactor<flatbuffers::grpc::Message<Monster>>*
            reactor);
    std::unique_ptr<
    ...
    void async_GetMaxHitPoint(
        ::grpc::ClientContext* context,
        flatbuffers::grpc::Message<Stat>* response,
        ::grpc::ClientWriteReactor<flatbuffers::grpc::Message<Monster>>*
            reactor);
    std::unique_ptr<
...
class MonsterStorage::CallbackService : public ::grpc::Service {
 public:
  ...
  virtual ::grpc::ServerUnaryReactor* Store(
      ...
      const flatbuffers::grpc::Message<Monster>* request,
      flatbuffers::grpc::Message<Stat>* response);
  virtual ::grpc::ServerWriteReactor<flatbuffers::grpc::Message<Monster>>*
  Retrieve(::grpc::CallbackServerContext* context,
           const flatbuffers::grpc::Message<Stat>* request);
  virtual ::grpc::ServerReadReactor<flatbuffers::grpc::Message<Monster>>*
  GetMaxHitPoint(::grpc::CallbackServerContext* context,
                 flatbuffers::grpc::Message<Stat>* response);
  virtual ::grpc::ServerBidiReactor<flatbuffers::grpc::Message<Monster>,
                                    flatbuffers::grpc::Message<Stat>>*
  GetMinMaxHitPoints(::grpc::CallbackServerContext* context);
};
#else
