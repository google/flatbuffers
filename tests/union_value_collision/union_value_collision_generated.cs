...
namespace union_value_collision
{
...
public class ValueUnion {
  ...
  public union_value_collision.IntValueT AsIntValue() { return this.As<union_value_collision.IntValueT>(); }
  public static ValueUnion FromIntValue(union_value_collision.IntValueT _intvalue) { return new ValueUnion{ Type = Value.IntValue, Value_ = _intvalue }; }

  public static int Pack(Google.FlatBuffers.FlatBufferBuilder builder, ValueUnion _o) {
    switch (_o.Type) {
      default: return 0;
      case Value.IntValue: return union_value_collision.IntValue.Pack(builder, _o.AsIntValue()).Value;
    }
  }
}
...
public class ValueUnion_JsonConverter : Newtonsoft.Json.JsonConverter {
  ...
  public ValueUnion ReadJson(Newtonsoft.Json.JsonReader reader, ValueUnion _o, Newtonsoft.Json.JsonSerializer serializer) {
    ...
    switch (_o.Type) {
      default: break;
      case Value.IntValue: _o.Value_ = serializer.Deserialize<union_value_collision.IntValueT>(reader); break;
    }
    return _o;
  }
}
...
static public class ValueVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, byte typeId, uint tablePos)
  {
    ...
    {
      case Value.IntValue:
        result = union_value_collision.IntValueVerify.Verify(verifier, tablePos);
        break;
      default: result = true;
        break;
    }
...
public class OtherUnion {
  ...
  public union_value_collision.IntValueT AsIntValue() { return this.As<union_value_collision.IntValueT>(); }
  public static OtherUnion FromIntValue(union_value_collision.IntValueT _intvalue) { return new OtherUnion{ Type = Other.IntValue, Value = _intvalue }; }

  public static int Pack(Google.FlatBuffers.FlatBufferBuilder builder, OtherUnion _o) {
    switch (_o.Type) {
      default: return 0;
      case Other.IntValue: return union_value_collision.IntValue.Pack(builder, _o.AsIntValue()).Value;
    }
  }
}
...
public class OtherUnion_JsonConverter : Newtonsoft.Json.JsonConverter {
  ...
  public OtherUnion ReadJson(Newtonsoft.Json.JsonReader reader, OtherUnion _o, Newtonsoft.Json.JsonSerializer serializer) {
    ...
    switch (_o.Type) {
      default: break;
      case Other.IntValue: _o.Value = serializer.Deserialize<union_value_collision.IntValueT>(reader); break;
    }
    return _o;
  }
}
...
public struct IntValue : IFlatbufferObject
{
  ...
  public static Offset<union_value_collision.IntValue> CreateIntValue(FlatBufferBuilder builder,
      int value = 0) {
  ...
  public static Offset<union_value_collision.IntValue> EndIntValue(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<union_value_collision.IntValue>(o);
  }
  ...
  public static Offset<union_value_collision.IntValue> Pack(FlatBufferBuilder builder, IntValueT _o) {
    if (_o == null) return default(Offset<union_value_collision.IntValue>);
...
public struct Collide : IFlatbufferObject
{
  ...
  public static Offset<union_value_collision.Collide> CreateCollide(FlatBufferBuilder builder,
  ...
  public static Offset<union_value_collision.Collide> EndCollide(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    builder.Required(o, 4);  // collide
    return new Offset<union_value_collision.Collide>(o);
  }
  ...
  public static Offset<union_value_collision.Collide> Pack(FlatBufferBuilder builder, CollideT _o) {
    if (_o == null) return default(Offset<union_value_collision.Collide>);
...
public struct Collision : IFlatbufferObject
{
  ...
  public union_value_collision.Value SomeValueType { get { int o = __p.__offset(4); return o != 0 ? (union_value_collision.Value)__p.bb.Get(o + __p.bb_pos) : union_value_collision.Value.NONE; } }
  ...
  public union_value_collision.IntValue SomeValueAsIntValue() { return SomeValue<union_value_collision.IntValue>().Value; }
  public union_value_collision.Other ValueType { get { int o = __p.__offset(8); return o != 0 ? (union_value_collision.Other)__p.bb.Get(o + __p.bb_pos) : union_value_collision.Other.NONE; } }
  ...
  public union_value_collision.IntValue ValueAsIntValue() { return Value<union_value_collision.IntValue>().Value; }
  public union_value_collision.Collision? Collide(int j) { int o = __p.__offset(12); return o != 0 ? (union_value_collision.Collision?)(new union_value_collision.Collision()).__assign(__p.__indirect(__p.__vector(o) + j * 4), __p.bb) : null; }
  public int CollideLength { get { int o = __p.__offset(12); return o != 0 ? __p.__vector_len(o) : 0; } }

  public static Offset<union_value_collision.Collision> CreateCollision(FlatBufferBuilder builder,
      union_value_collision.Value some_value_type = union_value_collision.Value.NONE,
      int some_valueOffset = 0,
      union_value_collision.Other value_type = union_value_collision.Other.NONE,
      int valueOffset = 0,
  ...
  public static void AddSomeValueType(FlatBufferBuilder builder, union_value_collision.Value someValueType) { builder.AddByte(0, (byte)someValueType, 0); }
  public static void AddSomeValue(FlatBufferBuilder builder, int someValueOffset) { builder.AddOffset(1, someValueOffset, 0); }
  public static void AddValueType(FlatBufferBuilder builder, union_value_collision.Other valueType) { builder.AddByte(2, (byte)valueType, 0); }
  ...
  public static VectorOffset CreateCollideVector(FlatBufferBuilder builder, Offset<union_value_collision.Collision>[] data) { builder.StartVector(4, data.Length, 4); for (int i = data.Length - 1; i >= 0; i--) builder.AddOffset(data[i].Value); return builder.EndVector(); }
  public static VectorOffset CreateCollideVectorBlock(FlatBufferBuilder builder, Offset<union_value_collision.Collision>[] data) { builder.StartVector(4, data.Length, 4); builder.Add(data); return builder.EndVector(); }
  public static VectorOffset CreateCollideVectorBlock(FlatBufferBuilder builder, ArraySegment<Offset<union_value_collision.Collision>> data) { builder.StartVector(4, data.Count, 4); builder.Add(data); return builder.EndVector(); }
  public static VectorOffset CreateCollideVectorBlock(FlatBufferBuilder builder, IntPtr dataPtr, int sizeInBytes) { builder.StartVector(1, sizeInBytes, 1); builder.Add<Offset<union_value_collision.Collision>>(dataPtr, sizeInBytes); return builder.EndVector(); }
  public static void StartCollideVector(FlatBufferBuilder builder, int numElems) { builder.StartVector(4, numElems, 4); }
  public static Offset<union_value_collision.Collision> EndCollision(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<union_value_collision.Collision>(o);
  }
  public static void FinishCollisionBuffer(FlatBufferBuilder builder, Offset<union_value_collision.Collision> offset) { builder.Finish(offset.Value); }
  public static void FinishSizePrefixedCollisionBuffer(FlatBufferBuilder builder, Offset<union_value_collision.Collision> offset) { builder.FinishSizePrefixed(offset.Value); }
  ...
  public void UnPackTo(CollisionT _o) {
    _o.SomeValue = new union_value_collision.ValueUnion();
    _o.SomeValue.Type = this.SomeValueType;
    switch (this.SomeValueType) {
      default: break;
      case union_value_collision.Value.IntValue:
        _o.SomeValue.Value_ = this.SomeValue<union_value_collision.IntValue>().HasValue ? this.SomeValue<union_value_collision.IntValue>().Value.UnPack() : null;
        break;
    }
    _o.Value = new union_value_collision.OtherUnion();
    _o.Value.Type = this.ValueType;
    switch (this.ValueType) {
      default: break;
      case union_value_collision.Other.IntValue:
        _o.Value.Value = this.Value<union_value_collision.IntValue>().HasValue ? this.Value<union_value_collision.IntValue>().Value.UnPack() : null;
        break;
    }
    _o.Collide = new List<union_value_collision.CollisionT>();
    for (var _j = 0; _j < this.CollideLength; ++_j) {_o.Collide.Add(this.Collide(_j).HasValue ? this.Collide(_j).Value.UnPack() : null);}
  }
  public static Offset<union_value_collision.Collision> Pack(FlatBufferBuilder builder, CollisionT _o) {
    if (_o == null) return default(Offset<union_value_collision.Collision>);
    var _some_value_type = _o.SomeValue == null ? union_value_collision.Value.NONE : _o.SomeValue.Type;
    var _some_value = _o.SomeValue == null ? 0 : union_value_collision.ValueUnion.Pack(builder, _o.SomeValue);
    var _value_type = _o.Value == null ? union_value_collision.Other.NONE : _o.Value.Type;
    var _value = _o.Value == null ? 0 : union_value_collision.OtherUnion.Pack(builder, _o.Value);
    var _collide = default(VectorOffset);
    if (_o.Collide != null) {
      var __collide = new Offset<union_value_collision.Collision>[_o.Collide.Count];
      for (var _j = 0; _j < __collide.Length; ++_j) { __collide[_j] = union_value_collision.Collision.Pack(builder, _o.Collide[_j]); }
...
public class CollisionT
{
  ...
  private union_value_collision.Value SomeValueType {
    get {
      return this.SomeValue != null ? this.SomeValue.Type : union_value_collision.Value.NONE;
    }
    set {
      this.SomeValue = new union_value_collision.ValueUnion();
      this.SomeValue.Type = value;
    }
  }
  [Newtonsoft.Json.JsonProperty("some_value")]
  [Newtonsoft.Json.JsonConverter(typeof(union_value_collision.ValueUnion_JsonConverter))]
  public union_value_collision.ValueUnion SomeValue { get; set; }
  [Newtonsoft.Json.JsonProperty("value_type")]
  private union_value_collision.Other ValueType {
    get {
      return this.Value != null ? this.Value.Type : union_value_collision.Other.NONE;
    }
    set {
      this.Value = new union_value_collision.OtherUnion();
      this.Value.Type = value;
    }
  }
  [Newtonsoft.Json.JsonProperty("value")]
  [Newtonsoft.Json.JsonConverter(typeof(union_value_collision.OtherUnion_JsonConverter))]
  public union_value_collision.OtherUnion Value { get; set; }
  [Newtonsoft.Json.JsonProperty("collide")]
  public List<union_value_collision.CollisionT> Collide { get; set; }
...
static public class CollisionVerify
{
  ...
  {
    return verifier.VerifyTableStart(tablePos)
      && verifier.VerifyField(tablePos, 4 /*SomeValueType*/, 1 /*union_value_collision.Value*/, 1, false)
      && verifier.VerifyUnion(tablePos, 4, 6 /*SomeValue*/, union_value_collision.ValueVerify.Verify, false)
      && verifier.VerifyField(tablePos, 8 /*ValueType*/, 1 /*union_value_collision.Other*/, 1, false)
      && verifier.VerifyUnion(tablePos, 8, 10 /*Value*/, union_value_collision.OtherVerify.Verify, false)
      && verifier.VerifyVectorOfTables(tablePos, 12 /*Collide*/, union_value_collision.CollisionVerify.Verify, false)
      && verifier.VerifyTableEnd(tablePos);
  }
}
