...
impl<'a> TableInC<'a> {
    ...
    pub fn refer_to_a1(&self) -> Option<super::namespace_a::TableInFirstNS<'a>> {
        ...
        unsafe { self.tab.get::<::flatbuffers::ForwardsUOffset<super::namespace_a::TableInFirstNS>>(TableInC::VT_REFER_TO_A1, None)}
    }
    ...
    pub fn refer_to_a2(&self) -> Option<super::namespace_a::SecondTableInA<'a>> {
        ...
        // Created from valid Table for this object
        // which contains a valid value in this slot
        unsafe { self.tab.get::<::flatbuffers::ForwardsUOffset<super::namespace_a::SecondTableInA>>(TableInC::VT_REFER_TO_A2, None)}
    }
}
...
impl TableInCT {
    ...
    pub fn pack<'b, A: ::flatbuffers::Allocator + 'b>(
        ...
        TableInC::create(fbb, &TableInCArgs{
            refer_to_a1,
            refer_to_a2,
        })
    }
