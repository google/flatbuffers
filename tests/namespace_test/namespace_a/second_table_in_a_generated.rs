...
impl<'a> SecondTableInA<'a> {
    ...
    #[inline]
    pub fn refer_to_c(&self) -> Option<super::super::namespace_c::TableInC<'a>> {
        // Safety:
        // Created from valid Table for this object
        // which contains a valid value in this slot
        unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<super::super::namespace_c::TableInC>>(SecondTableInA::VT_REFER_TO_C, None)}
    }
}
...
impl ::flatbuffers::Verifiable for SecondTableInA<'_> {
    ...
    fn run_verifier(
        ...
        v.visit_table(pos)?
            .visit_field::<::flatbuffers::ForwardsUOffset<super::super::namespace_c::TableInC>>("refer_to_c", Self::VT_REFER_TO_C, false)?
            .finish();
        Ok(())
    }
}
...
pub struct SecondTableInAArgs<'a> {
    pub refer_to_c: Option<::flatbuffers::WIPOffset<super::super::namespace_c::TableInC<'a>>>,
}
...
impl<'a: 'b, 'b, A: ::flatbuffers::Allocator + 'a> SecondTableInABuilder<'a, 'b, A> {
    #[inline]
    pub fn add_refer_to_c(&mut self, refer_to_c: ::flatbuffers::WIPOffset<super::super::namespace_c::TableInC<'b >>) {
        self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<super::super::namespace_c::TableInC>>(SecondTableInA::VT_REFER_TO_C, refer_to_c);
    }
...
pub struct SecondTableInAT {
    pub refer_to_c: Option<alloc::boxed::Box<super::super::namespace_c::TableInCT>>,
}
