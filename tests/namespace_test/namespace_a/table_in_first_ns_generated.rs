...
impl<'a> TableInFirstNS<'a> {
    ...
    pub fn foo_table(&self) -> Option<namespace_b::TableInNestedNS<'a>> {
        ...
        unsafe { self.tab.get::<::flatbuffers::ForwardsUOffset<namespace_b::TableInNestedNS>>(TableInFirstNS::VT_FOO_TABLE, None)}
    }
    ...
    pub fn foo_enum(&self) -> namespace_b::EnumInNestedNS {
        ...
        // Created from valid Table for this object
        // which contains a valid value in this slot
        unsafe { self.tab.get::<namespace_b::EnumInNestedNS>(TableInFirstNS::VT_FOO_ENUM, Some(namespace_b::EnumInNestedNS::A)).unwrap()}
    }
    ...
    pub fn foo_union_type(&self) -> namespace_b::UnionInNestedNS {
        ...
        // Created from valid Table for this object
        // which contains a valid value in this slot
        unsafe { self.tab.get::<namespace_b::UnionInNestedNS>(TableInFirstNS::VT_FOO_UNION_TYPE, Some(namespace_b::UnionInNestedNS::NONE)).unwrap()}
    }
    ...
    pub fn foo_union(&self) -> Option<::flatbuffers::Table<'a>> {
        ...
        // Created from valid Table for this object
        // which contains a valid value in this slot
        unsafe { self.tab.get::<::flatbuffers::ForwardsUOffset<::flatbuffers::Table<'a>>>(TableInFirstNS::VT_FOO_UNION, None)}
    }
    ...
    pub fn foo_struct(&self) -> Option<&'a namespace_b::StructInNestedNS> {
        ...
        // Created from valid Table for this object
        // which contains a valid value in this slot
        unsafe { self.tab.get::<namespace_b::StructInNestedNS>(TableInFirstNS::VT_FOO_STRUCT, None)}
    }
...
impl TableInFirstNST {
    ...
    pub fn pack<'b, A: ::flatbuffers::Allocator + 'b>(
        ...
        debug_assert!(foo_union.is_some() || foo_union_type == namespace_b::UnionInNestedNS::NONE, "Union discriminant does not match packed value");
        let foo_struct_tmp = self.foo_struct.as_ref().map(|x| x.pack());
        let foo_struct = foo_struct_tmp.as_ref();
        TableInFirstNS::create(fbb, &TableInFirstNSArgs{
            foo_table,
            foo_enum,
            foo_union_type,
            foo_union,
