...
public final class TableInNestedNS extends Table {
  ...
  public static TableInNestedNS getSizePrefixedRootAsTableInNestedNS(ByteBuffer _bb, TableInNestedNS obj) { ByteBuffer __bb = _bb.slice(); __bb.position(Constants.SIZE_PREFIX_LENGTH); return getRootAsTableInNestedNS(__bb, obj); }
