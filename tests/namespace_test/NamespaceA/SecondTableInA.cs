...
public struct SecondTableInA : IFlatbufferObject
{
  ...
  public static SecondTableInA GetSizePrefixedRootAsSecondTableInA(ByteBuffer _bb) { return GetSizePrefixedRootAsSecondTableInA(_bb, new SecondTableInA()); }
  ...
  public static SecondTableInA GetSizePrefixedRootAsSecondTableInA(ByteBuffer _bb, SecondTableInA obj) { ByteBuffer __bb = _bb.Slice(); __bb.Position = FlatBufferConstants.SizePrefixLength; return GetRootAsSecondTableInA(__bb, obj); }
