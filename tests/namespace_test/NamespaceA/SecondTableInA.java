...
public final class SecondTableInA extends Table {
  ...
  public static SecondTableInA getSizePrefixedRootAsSecondTableInA(ByteBuffer _bb, SecondTableInA obj) { ByteBuffer __bb = _bb.slice(); __bb.position(Constants.SIZE_PREFIX_LENGTH); return getRootAsSecondTableInA(__bb, obj); }
