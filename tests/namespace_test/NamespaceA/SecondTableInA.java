...
public final class SecondTableInA extends Table {
  ...
  public static SecondTableInA getSizePrefixedRootAsSecondTableInA(ByteBuffer _psbb, SecondTableInA obj) { ByteBuffer _bb = _psbb.slice(); _bb.position(Constants.SIZE_PREFIX_LENGTH); return getRootAsSecondTableInA(_bb, obj); }
