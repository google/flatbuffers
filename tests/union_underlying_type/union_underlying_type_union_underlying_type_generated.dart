...
class ABTypeId {
  ...
  factory ABTypeId.fromValue(int value) {
    ...
    if (result == null) {
      throw StateError('Invalid value $value for bit flag enum ABTypeId');
    }
    return result;
  }
  ...
  static const ABTypeId NONE = ABTypeId._(0);
  static const ABTypeId A = ABTypeId._(1);
  static const ABTypeId B = ABTypeId._(2);
  static const Map<int, ABTypeId> values = {
    0: NONE,
    1: A,
    2: B};

  static const fb.Reader<ABTypeId> reader = _ABTypeIdReader();
...
class _ABTypeIdReader extends fb.Reader<ABTypeId> {
  ...
  ABTypeId read(fb.BufferContext bc, int offset) =>
      ABTypeId.fromValue(const fb.Int32Reader().read(bc, offset));
}
...
class ABTable {
  ...
  static const fb.Reader<ABTable> reader = _ABTableReader();
