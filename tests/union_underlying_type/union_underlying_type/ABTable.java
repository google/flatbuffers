...
public final class ABTable extends Table {
  ...
  public void unpackTo(ABTableT _o) {
    ...
    union_underlying_type.ABUnion _oAb = new union_underlying_type.ABUnion();
    int _oAbType = abType();
    _oAb.setType(_oAbType);
    Table _oAbValue;
    switch (_oAbType) {
      case union_underlying_type.AB.A:
        _oAbValue = ab(new union_underlying_type.A());
        _oAb.setValue(_oAbValue != null ? ((union_underlying_type.A) _oAbValue).unpack() : null);
        break;
      case union_underlying_type.AB.B:
        _oAbValue = ab(new union_underlying_type.B());
        _oAb.setValue(_oAbValue != null ? ((union_underlying_type.B) _oAbValue).unpack() : null);
        break;
      default: break;
    }
    _o.setAb(_oAb);
  ...
  public static int pack(FlatBufferBuilder builder, ABTableT _o) {
    if (_o == null) return 0;
    int _abType = _o.getAb() == null ? union_underlying_type.AB.NONE : _o.getAb().getType();
    int _ab = _o.getAb() == null ? 0 : union_underlying_type.ABUnion.pack(builder, _o.getAb());
