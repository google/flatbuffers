...
public struct B : IFlatbufferObject
{
  ...
  public static Offset<union_underlying_type.B> EndB(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<union_underlying_type.B>(o);
  }
  public BT UnPack() {
    var _o = new BT();
    this.UnPackTo(_o);
  ...
  public static Offset<union_underlying_type.B> Pack(FlatBufferBuilder builder, BT _o) {
    if (_o == null) return default(Offset<union_underlying_type.B>);
    StartB(builder);
    return EndB(builder);
  }
}
