...
public class ABUnion {
  ...
  public union_underlying_type.AT AsA() { return this.As<union_underlying_type.AT>(); }
  public static ABUnion FromA(union_underlying_type.AT _a) { return new ABUnion{ Type = AB.A, Value = _a }; }
  public union_underlying_type.BT AsB() { return this.As<union_underlying_type.BT>(); }
  public static ABUnion FromB(union_underlying_type.BT _b) { return new ABUnion{ Type = AB.B, Value = _b }; }

  public static int Pack(FlatBuffers.FlatBufferBuilder builder, ABUnion _o) {
    switch (_o.Type) {
      default: return 0;
      case AB.A: return union_underlying_type.A.Pack(builder, _o.AsA()).Value;
      case AB.B: return union_underlying_type.B.Pack(builder, _o.AsB()).Value;
    }
  }
}
...
public class ABUnion_JsonConverter : Newtonsoft.Json.JsonConverter {
  ...
  public ABUnion ReadJson(Newtonsoft.Json.JsonReader reader, ABUnion _o, Newtonsoft.Json.JsonSerializer serializer) {
    ...
    switch (_o.Type) {
      default: break;
      case AB.A: _o.Value = serializer.Deserialize<union_underlying_type.AT>(reader); break;
      case AB.B: _o.Value = serializer.Deserialize<union_underlying_type.BT>(reader); break;
    }
    return _o;
  }
}
