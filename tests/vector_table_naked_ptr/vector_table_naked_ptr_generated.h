...
struct B FLATBUFFERS_FINAL_CLASS : private ::flatbuffers::Table {
  ...
  bool mutate_id(int32_t _id = 0) { return SetField<int32_t>(VT_ID, _id, 0); }
  template <bool B = false>
  bool Verify(::flatbuffers::VerifierTemplate<B>& verifier) const {
    return VerifyTableStart(verifier) &&
           VerifyField<int32_t>(verifier, VT_ID, 4) && verifier.EndTable();
  }
  BT* UnPack(
...
struct BBuilder {
  ...
  void add_id(int32_t id) { fbb_.AddElement<int32_t>(B::VT_ID, id, 0); }
...
inline ::flatbuffers::Offset<B> CreateB(::flatbuffers::FlatBufferBuilder& _fbb,
                                        int32_t id = 0) {
...
struct A FLATBUFFERS_FINAL_CLASS : private ::flatbuffers::Table {
  ...
  const ::flatbuffers::Vector<::flatbuffers::Offset<B>>* b() const {
    return GetPointer<const ::flatbuffers::Vector<::flatbuffers::Offset<B>>*>(
        VT_B);
  }
  ...
  bool Verify(::flatbuffers::VerifierTemplate<B>& verifier) const {
    return VerifyTableStart(verifier) && VerifyOffset(verifier, VT_B) &&
           verifier.VerifyVector(b()) && verifier.VerifyVectorOfTables(b()) &&
           verifier.EndTable();
  }
  AT* UnPack(
      const ::flatbuffers::resolver_function_t* _resolver = nullptr) const;
...
struct ABuilder {
  ...
  ::flatbuffers::uoffset_t start_;
  void add_b(
      ::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<B>>>
          b) {
...
inline ::flatbuffers::Offset<A> CreateA(
    ...
    ::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<B>>> b =
        0) {
...
inline ::flatbuffers::Offset<B> B::Pack(
  ...
  (void)_va;
  auto _id = _o->id;
  return CreateB(_fbb, _id);
}

inline bool operator==(const AT& lhs, const AT& rhs) {
  return (lhs.b.size() == rhs.b.size() &&
          std::equal(lhs.b.cbegin(), lhs.b.cend(), rhs.b.cbegin(),
                     [](BT* const& a, BT* const& b) {
                       return (a == b) || (a && b && *a == *b);
                     }));
}
...
inline AT::AT(const AT& o) {
  b.reserve(o.b.size());
  for (const auto& b_ : o.b) {
    b.emplace_back((b_) ? new BT(*b_) : nullptr);
  }
}
  ...
  (void)_resolver;
  {
    ...
    if (_e) {
      ...
      for (::flatbuffers::uoffset_t _i = 0; _i < _e->size(); _i++) {
        if (_o->b[_i]) {
          _e->Get(_i)->UnPackTo(_o->b[_i], _resolver);
        } else {
          _o->b[_i] = (_e->Get(_i)->UnPack(_resolver));
        }
      }
    } else {
      _o->b.resize(0);
...
inline ::flatbuffers::Offset<A> A::Pack(
  ...
  (void)_va;
  auto _b = _o->b.size() ? _fbb.CreateVector<::flatbuffers::Offset<B>>(
                               _o->b.size(),
                               [](size_t i, _VectorArgs* __va) {
                                 return CreateB(*__va->__fbb, __va->__o->b[i],
                                                __va->__rehasher);
                               },
                               &_va)
                         : 0;
  return CreateA(_fbb, _b);
}
...
inline const ::flatbuffers::TypeTable* ATypeTable() {
  ...
  static const ::flatbuffers::TypeFunction type_refs[] = {BTypeTable};
...
inline const A* GetA(const void* buf) { return ::flatbuffers::GetRoot<A>(buf); }
...
template <bool B = false>
inline bool VerifyABuffer(::flatbuffers::VerifierTemplate<B>& verifier) {
...
inline void FinishABuffer(::flatbuffers::FlatBufferBuilder& fbb,
                          ::flatbuffers::Offset<A> root) {
  fbb.Finish(root);
}

inline void FinishSizePrefixedABuffer(::flatbuffers::FlatBufferBuilder& fbb,
                                      ::flatbuffers::Offset<A> root) {
  fbb.FinishSizePrefixed(root);
}

inline AT* UnPackA(const void* buf,
