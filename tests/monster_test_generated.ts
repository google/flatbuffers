 ...
 * @returns StringKey
 */
__init(i:number, bb:flatbuffers.ByteBuffer):StringKey {
  this.bb_pos = i;
  this.bb = bb;
  return this;
};
 ...
 * @returns StringKey
 */
static getRootAsStringKey(bb:flatbuffers.ByteBuffer, obj?:StringKey):StringKey {
  return (obj || new StringKey()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
};
 ...
 * @returns StringKey
 */
static getSizePrefixedRootAsStringKey(bb:flatbuffers.ByteBuffer, obj?:StringKey):StringKey {
  bb.setPosition(bb.position() + flatbuffers.SIZE_PREFIX_LENGTH);
  return (obj || new StringKey()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
};
 ...
 * @param flatbuffers.Builder builder
 */
static startStringKey(builder:flatbuffers.Builder) {
  builder.startObject(1);
};
 ...
 * @returns flatbuffers.Offset
 */
static endStringKey(builder:flatbuffers.Builder):flatbuffers.Offset {
  var offset = builder.endObject();
  builder.requiredField(offset, 4); // k
  return offset;
};

static createStringKey(builder:flatbuffers.Builder, kOffset:flatbuffers.Offset):flatbuffers.Offset {
  StringKey.startStringKey(builder);
...
static deserialize(buffer: Uint8Array):StringKey {
  return StringKey.getRootAsStringKey(new flatbuffers.ByteBuffer(buffer))
}
 ...
 * @param StringKeyT _o
 */
unpackTo(_o: StringKeyT): void {
  _o.k = this.k();
};
}

export class StringKeyT {
/**
 * @constructor
 * @param string|Uint8Array|null k
 */
constructor(
  public k: string|Uint8Array|null = null
){};
 ...
 */
pack(builder:flatbuffers.Builder): flatbuffers.Offset {
  const k = (this.k !== null ? builder.createString(this.k!) : 0);

  return MyGame.Example.StringKey.createStringKey(builder,
    k
  );
};
}
