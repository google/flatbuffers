...
import { EnumVal, enumValVerify } from '../reflection/enum-val.js';
import { KeyValue, keyValueVerify } from '../reflection/key-value.js';
import { Type, typeVerify } from '../reflection/type.js';
export class Enum {
    constructor() {
        this.bb = null;
        this.bb_pos = 0;
...
export function enum_Verify(verifier, tablePos) {
    let result = true;
