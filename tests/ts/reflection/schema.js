...
import { Enum, enum_Verify } from '../reflection/enum.js';
import { Object_, object_Verify } from '../reflection/object.js';
import { SchemaFile, schemaFileVerify } from '../reflection/schema-file.js';
import { Service, serviceVerify } from '../reflection/service.js';
export class Schema {
    constructor() {
        this.bb = null;
        this.bb_pos = 0;
...
export function schemaVerify(verifier, tablePos) {
    let result = true;
