...
export function unionToGadget(
  ...
  switch (Gadget[type]) {
    case "NONE":
      return null;
    case "FallingTub":
      return accessor(new FallingTub())! as FallingTub;
    case "HandFan":
      return accessor(new HandFan())! as HandFan;
    default:
      return null;
  }
}
...
export function unionListToGadget(
  ...
  switch (Gadget[type]) {
    case "NONE":
      return null;
    case "FallingTub":
      return accessor(index, new FallingTub())! as FallingTub;
    case "HandFan":
      return accessor(index, new HandFan())! as HandFan;
    default:
      return null;
  }
}
