...
export function unionToCharacter(
  ...
  switch (Character[type]) {
    case "NONE":
      return null;
    case "MuLan":
      return accessor(new Attacker())! as Attacker;
    case "Rapunzel":
      return accessor(new Rapunzel())! as Rapunzel;
    case "Belle":
      return accessor(new BookReader())! as BookReader;
    case "BookFan":
      return accessor(new BookReader())! as BookReader;
    case "Other":
...
export function unionListToCharacter(
  ...
  switch (Character[type]) {
    case "NONE":
      return null;
    case "MuLan":
      return accessor(index, new Attacker())! as Attacker;
    case "Rapunzel":
      return accessor(index, new Rapunzel())! as Rapunzel;
    case "Belle":
      return accessor(index, new BookReader())! as BookReader;
    case "BookFan":
      return accessor(index, new BookReader())! as BookReader;
    case "Other":
      return accessor(index, "") as string;
    case "Unused":
      return accessor(index, "") as string;
    default:
      return null;
