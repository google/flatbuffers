...
import { Any, unionToAny, unionListToAny, anyVerify } from '../../my-game/example/any.js';
import { AnyAmbiguousAliases, unionToAnyAmbiguousAliases, unionListToAnyAmbiguousAliases, anyAmbiguousAliasesVerify } from '../../my-game/example/any-ambiguous-aliases.js';
import { AnyUniqueAliases, unionToAnyUniqueAliases, unionListToAnyUniqueAliases, anyUniqueAliasesVerify } from '../../my-game/example/any-unique-aliases.js';
import { Color } from '../../my-game/example/color.js';
import { Race } from '../../my-game/example/race.js';
import { Referrable, referrableVerify, ReferrableT } from '../../my-game/example/referrable.js';
import { Stat, statVerify, StatT } from '../../my-game/example/stat.js';
...
import { InParentNamespace, inParentNamespaceVerify, InParentNamespaceT } from '../../my-game/in-parent-namespace.js';
...
static verifyMonster(bb:flatbuffers.ByteBuffer, sizePrefix?:boolean):boolean {
  let verifier = flatbuffers.newVerifier(bb);
  if (sizePrefix == null) sizePrefix = true;
  return verifier.verifyBuffer('MONS', sizePrefix, monsterVerify);
}
...
export function monsterVerify(verifier: flatbuffers.Verifier, tablePos: flatbuffers.UOffset): boolean {
  ...
  result = result && verifier.verifyVectorOfData(tablePos, 14 /*Inventory*/, 1 /*Uint8*/, false);
  result = result && verifier.verifyField(tablePos, 16 /*Color*/, 1 /*Uint8*/, 1, false);
  result = result && verifier.verifyField(tablePos, 18 /*TestType*/, 1 /*Uint8*/, 1, false);
  ...
  result = result && verifier.verifyField(tablePos, 34 /*Testbool*/, 1 /*Int8*/, 1, false);
  ...
  result = result && verifier.verifyVectorOfData(tablePos, 52 /*Testarrayofbools*/, 1 /*Int8*/, false);
  ...
  result = result && verifier.verifyTable(tablePos, 72 /*ParentNamespaceTest*/, inParentNamespaceVerify, false);
  ...
  result = result && verifier.verifyField(tablePos, 90 /*AnyUniqueType*/, 1 /*Uint8*/, 1, false);
  result = result && verifier.verifyUnion(tablePos, 90, 92 /*AnyUnique*/, anyUniqueAliasesVerify, false);
  result = result && verifier.verifyField(tablePos, 94 /*AnyAmbiguousType*/, 1 /*Uint8*/, 1, false);
  result = result && verifier.verifyUnion(tablePos, 94, 96 /*AnyAmbiguous*/, anyAmbiguousAliasesVerify, false);
  result = result && verifier.verifyVectorOfData(tablePos, 98 /*VectorOfEnums*/, 1 /*Uint8*/, false);
  result = result && verifier.verifyField(tablePos, 100 /*SignedEnum*/, 1 /*Int8*/, 1, false);
  ...
  result = result && verifier.verifyField(tablePos, 108 /*LongEnumNonEnumDefault*/, 8 /*Uint64*/, 8, false);
  result = result && verifier.verifyField(tablePos, 110 /*LongEnumNormalDefault*/, 8 /*Uint64*/, 8, false);
