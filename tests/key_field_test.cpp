...
void FixedSizedScalarKeyInStructTest() {
  ...
  TEST_EQ(sortedvecofbaz->LookupByKey(array_int), static_cast<const Baz*>(nullptr));
  ...
  TEST_EQ(sortedvecofbar->LookupByKey(array_float), static_cast<const Bar*>(nullptr));
