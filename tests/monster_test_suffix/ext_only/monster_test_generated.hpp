...
bool VerifyAny(::flatbuffers::VerifierTemplate<B>& verifier, const void* obj,
               Any type);
template <bool B = false>
...
template <bool B = false>
bool VerifyAnyUniqueAliases(::flatbuffers::VerifierTemplate<B>& verifier,
...
template <bool B = false>
bool VerifyAnyAmbiguousAliases(::flatbuffers::VerifierTemplate<B>& verifier,
...
struct Monster FLATBUFFERS_FINAL_CLASS : private ::flatbuffers::Table {
  ...
  MyGame::Example::Monster* mutable_test_as_Monster() {
    return test_type() == MyGame::Example::Any_Monster
               ? static_cast<MyGame::Example::Monster*>(mutable_test())
               : nullptr;
  }
  MyGame::Example::TestSimpleTableWithEnum*
  mutable_test_as_TestSimpleTableWithEnum() {
    return test_type() == MyGame::Example::Any_TestSimpleTableWithEnum
               ? static_cast<MyGame::Example::TestSimpleTableWithEnum*>(
                     mutable_test())
               : nullptr;
  }
  MyGame::Example2::Monster* mutable_test_as_MyGame_Example2_Monster() {
    return test_type() == MyGame::Example::Any_MyGame_Example2_Monster
               ? static_cast<MyGame::Example2::Monster*>(mutable_test())
               : nullptr;
  }
  ...
  template <typename T>
  T* mutable_any_unique_as();
  MyGame::Example::Monster* mutable_any_unique_as_M() {
    return any_unique_type() == MyGame::Example::AnyUniqueAliases_M
               ? static_cast<MyGame::Example::Monster*>(mutable_any_unique())
               : nullptr;
  }
  ...
  MyGame::Example2::Monster* mutable_any_unique_as_M2() {
    return any_unique_type() == MyGame::Example::AnyUniqueAliases_M2
               ? static_cast<MyGame::Example2::Monster*>(mutable_any_unique())
               : nullptr;
  }
  ...
  MyGame::Example::Monster* mutable_any_ambiguous_as_M1() {
    return any_ambiguous_type() == MyGame::Example::AnyAmbiguousAliases_M1
               ? static_cast<MyGame::Example::Monster*>(mutable_any_ambiguous())
               : nullptr;
  }
  ...
  bool Verify(::flatbuffers::VerifierTemplate<B>& verifier) const {
    return VerifyTableStart(verifier) &&
           ...
           verifier.template VerifyNestedFlatBuffer<MyGame::Example::Monster>(
...
template <>
inline MyGame::Example::Monster*
Monster::mutable_test_as<MyGame::Example::Monster>() {
...
template <>
inline MyGame::Example::TestSimpleTableWithEnum*
Monster::mutable_test_as<MyGame::Example::TestSimpleTableWithEnum>() {
...
template <>
inline MyGame::Example2::Monster*
Monster::mutable_test_as<MyGame::Example2::Monster>() {
...
template <>
inline MyGame::Example::Monster*
Monster::mutable_any_unique_as<MyGame::Example::Monster>() {
...
template <>
inline MyGame::Example::TestSimpleTableWithEnum*
Monster::mutable_any_unique_as<MyGame::Example::TestSimpleTableWithEnum>() {
...
template <>
inline MyGame::Example2::Monster*
Monster::mutable_any_unique_as<MyGame::Example2::Monster>() {
...
inline ::flatbuffers::Offset<Monster> Monster::Pack(
      ...
      _o->testarrayoftables.size()
          ? _fbb.CreateVector<::flatbuffers::Offset<MyGame::Example::Monster>>(
                ...
                [](size_t i, _VectorArgs* __va) {
                  return MyGame::Example::CreateMonster(
                      *__va->__fbb, __va->__o->testarrayoftables[i].get(),
                      __va->__rehasher);
                },
                &_va)
          : 0;
  auto _enemy = _o->enemy ? MyGame::Example::CreateMonster(
                                _fbb, _o->enemy.get(), _rehasher)
                          : 0;
  auto _testnestedflatbuffer = _o->testnestedflatbuffer.size()
                                   ? _fbb.CreateVector(_o->testnestedflatbuffer)
                                   : 0;
  auto _testempty = _o->testempty ? MyGame::Example::CreateStat(
                                        _fbb, _o->testempty.get(), _rehasher)
                                  : 0;
  ...
  auto _parent_namespace_test =
      _o->parent_namespace_test
          ? MyGame::CreateInParentNamespace(
                _fbb, _o->parent_namespace_test.get(), _rehasher)
          : 0;
...
template <bool B>
inline bool VerifyAny(::flatbuffers::VerifierTemplate<B>& verifier,
...
template <bool B>
inline bool VerifyAnyUniqueAliases(::flatbuffers::VerifierTemplate<B>& verifier,
                                   const void* obj, AnyUniqueAliases type) {
  switch (type) {
    case AnyUniqueAliases_NONE: {
      return true;
...
inline bool VerifyAnyAmbiguousAliases(
    ::flatbuffers::VerifierTemplate<B>& verifier, const void* obj,
    AnyAmbiguousAliases type) {
  switch (type) {
    case AnyAmbiguousAliases_NONE: {
      return true;
...
template <bool B = false>
inline bool VerifyMonsterBuffer(::flatbuffers::VerifierTemplate<B>& verifier) {
  return verifier.template VerifyBuffer<MyGame::Example::Monster>(
      MonsterIdentifier());
}
...
inline bool VerifySizePrefixedMonsterBuffer(
    ::flatbuffers::VerifierTemplate<B>& verifier) {
  return verifier.template VerifySizePrefixedBuffer<MyGame::Example::Monster>(
      MonsterIdentifier());
}
