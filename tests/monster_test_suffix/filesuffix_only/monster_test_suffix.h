...
inline bool operator==(const MonsterT &lhs, const MonsterT &rhs) {
  return
      ...
      (lhs.testarrayoftables.size() == rhs.testarrayoftables.size() && std::equal(lhs.testarrayoftables.cbegin(), lhs.testarrayoftables.cend(), rhs.testarrayoftables.cbegin(), rhs.testarrayoftables.cend(), [](auto const &a, auto const &b) { return *a == *b;})) &&
      ...
      (lhs.vector_of_referrables.size() == rhs.vector_of_referrables.size() && std::equal(lhs.vector_of_referrables.cbegin(), lhs.vector_of_referrables.cend(), rhs.vector_of_referrables.cbegin(), rhs.vector_of_referrables.cend(), [](auto const &a, auto const &b) { return *a == *b;})) &&
      (lhs.single_weak_reference == rhs.single_weak_reference) &&
      (lhs.vector_of_weak_references == rhs.vector_of_weak_references) &&
      (lhs.vector_of_strong_referrables.size() == rhs.vector_of_strong_referrables.size() && std::equal(lhs.vector_of_strong_referrables.cbegin(), lhs.vector_of_strong_referrables.cend(), rhs.vector_of_strong_referrables.cbegin(), rhs.vector_of_strong_referrables.cend(), [](auto const &a, auto const &b) { return *a == *b;})) &&
      ...
      (lhs.scalar_key_sorted_tables.size() == rhs.scalar_key_sorted_tables.size() && std::equal(lhs.scalar_key_sorted_tables.cbegin(), lhs.scalar_key_sorted_tables.cend(), rhs.scalar_key_sorted_tables.cbegin(), rhs.scalar_key_sorted_tables.cend(), [](auto const &a, auto const &b) { return *a == *b;})) &&
