...
#[path = "../../preserve_case_rust/include_test1/mod.rs"]
pub mod include_test1_generated;

#[allow(dead_code, unused_imports, clippy::all)]
#[path = "../../preserve_case_rust/include_test2/mod.rs"]
pub mod include_test2_generated;

#[allow(dead_code, unused_imports, clippy::all)]
#[path = "../../preserve_case_rust/namespace_test/mod.rs"]
pub mod namespace_test_generated;

#[allow(dead_code, unused_imports, clippy::all)]
#[path = "../../preserve_case_rust/monster_test/mod.rs"]
mod monster_test_generated;
pub use monster_test_generated::my_game;

#[allow(dead_code, unused_imports, clippy::all)]
#[path = "../../preserve_case_rust/optional_scalars/mod.rs"]
mod optional_scalars_generated;

#[allow(dead_code, unused_imports, clippy::all)]
#[path = "../../preserve_case_rust/arrays_test/mod.rs"]
...
#[path = "../../preserve_case_rust/keyword_test/mod.rs"]
mod keyword_test_generated;

// Test rust namer, should not cause compiling issues
#[allow(dead_code, unused_imports, clippy::all)]
#[path = "../../preserve_case_rust/rust_namer_test/mod.rs"]
mod rust_namer_test;
...
mod follow_impls {
    ...
    // `../../preserve_case_rust/monster_test/mod.rs`.
