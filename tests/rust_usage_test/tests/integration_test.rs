...
mod flatbuffers_tests {
    ...
    fn builder_abort_with_greater_than_maximum_buffer_size() {
        flatbuffers::FlatBufferBuilder::new_with_capacity(
            flatbuffers::FLATBUFFERS_MAX_BUFFER_SIZE + 1,
        );
    }
    ...
    mod generated_constants {
        ...
        fn enum_constants_are_public() {
            ...
            assert_eq!(
                my_game::example::ENUM_VALUES_COLOR,
                [
            ...
            assert_eq!(
                my_game::example::ENUM_NAMES_COLOR,
                ["Red", "Green", "", "", "", "", "", "Blue"]
            );
            ...
            assert_eq!(
                my_game::example::ENUM_VALUES_RACE,
                [
            ...
            assert_eq!(
                my_game::example::ENUM_NAMES_RACE,
                ["None", "Human", "Dwarf", "Elf"]
            );

            assert_eq!(0, my_game::example::ENUM_MIN_ANY);
            assert_eq!(3, my_game::example::ENUM_MAX_ANY);
            assert_eq!(
                my_game::example::ENUM_VALUES_ANY,
                [
                    my_game::example::Any::NONE,
                    my_game::example::Any::Monster,
            ...
            assert_eq!(
                my_game::example::ENUM_NAMES_ANY,
                [
                    "NONE",
                    "Monster",
            ...
            assert_eq!(
                my_game::example::ENUM_VALUES_ANY_UNIQUE_ALIASES,
                [
            ...
            assert_eq!(
                my_game::example::ENUM_NAMES_ANY_UNIQUE_ALIASES,
                ["NONE", "M", "TS", "M2"]
            );
            ...
            assert_eq!(
                my_game::example::ENUM_VALUES_ANY_AMBIGUOUS_ALIASES,
                [
            ...
            assert_eq!(
                my_game::example::ENUM_NAMES_ANY_AMBIGUOUS_ALIASES,
                ["NONE", "M1", "M2", "M3"]
            );
        }
    }
    ...
    mod lifetime_correctness {
        ...
        fn table_get_field_from_static_buffer_1() {
            ...
            let name: Option<&'static str> =
                monster._tab.get::<flatbuffers::ForwardsUOffset<&str>>(
                    my_game::example::Monster::VT_NAME,
                    None,
                );
    ...
    mod roundtrip_vectors {
        ...
        mod scalar {
                    ...
                    + ::std::fmt::Debug,
            {
                ...
                let got =
                    <flatbuffers::ForwardsUOffset<flatbuffers::Vector<T>>>::follow(&buf[..], 0);
    ...
    mod roundtrip_table {
        ...
        fn table_of_byte_strings_fuzz() {
            fn prop(vec: Vec<Vec<u8>>) {
                ...
                for i in 0..xs.len() {
                    let v = tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<u8>>>(
        ...
        mod table_of_vectors_of_scalars {
                    ...
                    + ::std::fmt::Debug,
            {
                ...
                for i in 0..vecs.len() {
                    let got = tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<T>>>(
                        fi2fo(i as flatbuffers::VOffsetT),
                        None,
                    );
                    assert!(got.is_some());
    ...
    mod follow_impls {
        ...
        fn to_root_to_table_get_slot_string_multiple_types_default_via_vtable_len() {
            ...
            {
                assert_eq!(
                    tab.get::<flatbuffers::ForwardsUOffset<&[u8]>>(
                        fi2fo(0),
                        Some(&vec![70, 71, 72][..])
                    ),
                    Some(&vec![70, 71, 72][..])
    ...
    mod push_impls {
        ...
        fn push_u8_vector_with_offset_with_alignment() {
            ...
            check(
                &b,
                &[
                    /* loc */ 4, 0, 0, 0, /* len */ 9, 0, 0, 0, /* val */ 1, 2, 3,
                    4, 5, 6, 7, 8, 9, /* padding */ 0, 0, 0,
                ],
            );
        }
    ...
    mod byte_layouts {
        ...
        fn layout_01_basic_numbers() {
            ...
            check(
                &b,
                &[
                    0x32, 0x54, 0x76, 0x98, 204, 204, 204, 252, 0xEE, 0xFE, 0x22, 0x82, 0, 255,
                    129, 1,
                ],
            );
        }
