...
void MonsterStorage::Stub::async_Store(
    ::grpc::ClientContext* context,
    const flatbuffers::grpc::Message<Monster>& request,
    flatbuffers::grpc::Message<Stat>* response,
    std::function<void(::grpc::Status)> on_done) {
  ::grpc::internal::CallbackUnaryCall(channel_.get(), rpcmethod_Store_, context,
                                      &request, response, std::move(on_done));
}
...
void MonsterStorage::Stub::async_Store(
  ...
  ::grpc::internal::ClientCallbackUnaryFactory::Create(
      channel_.get(), rpcmethod_Store_, context, &request, response, reactor);
}
...
void MonsterStorage::Stub::async_Retrieve(
    ::grpc::ClientContext* context,
    const flatbuffers::grpc::Message<Stat>& request,
    ::grpc::ClientReadReactor<flatbuffers::grpc::Message<Monster>>* reactor) {
...
void MonsterStorage::Stub::async_GetMaxHitPoint(
    ::grpc::ClientContext* context, flatbuffers::grpc::Message<Stat>* response,
    ::grpc::ClientWriteReactor<flatbuffers::grpc::Message<Monster>>* reactor) {
...
void MonsterStorage::Stub::async_GetMinMaxHitPoints(
    ::grpc::ClientContext* context,
    ::grpc::ClientBidiReactor<flatbuffers::grpc::Message<Monster>,
                              flatbuffers::grpc::Message<Stat>>* reactor) {
...
MonsterStorage::CallbackService::CallbackService() {
  AddMethod(new ::grpc::internal::RpcServiceMethod(
      ...
      new ::grpc::internal::CallbackUnaryHandler<
          ...
          [this](::grpc::CallbackServerContext* ctx,
                 const flatbuffers::grpc::Message<Monster>* req,
                 flatbuffers::grpc::Message<Stat>* resp) {
  ...
  AddMethod(new ::grpc::internal::RpcServiceMethod(
      ...
      new ::grpc::internal::CallbackServerStreamingHandler<
          ...
          flatbuffers::grpc::Message<Monster>>(
          [this](::grpc::CallbackServerContext* ctx,
                 const flatbuffers::grpc::Message<Stat>* req) {
...
::grpc::ServerUnaryReactor* MonsterStorage::CallbackService::Store(
...
::grpc::ServerWriteReactor<flatbuffers::grpc::Message<Monster>>*
MonsterStorage::CallbackService::Retrieve(
    ::grpc::CallbackServerContext* /*context*/,
    const flatbuffers::grpc::Message<Stat>* /*request*/) {
  return nullptr;  // user must override
}

::grpc::ServerReadReactor<flatbuffers::grpc::Message<Monster>>*
MonsterStorage::CallbackService::GetMaxHitPoint(
    ::grpc::CallbackServerContext* /*context*/,
    flatbuffers::grpc::Message<Stat>* /*response*/) {
  return nullptr;  // user must override
}

::grpc::ServerBidiReactor<flatbuffers::grpc::Message<Monster>,
                          flatbuffers::grpc::Message<Stat>>*
MonsterStorage::CallbackService::GetMinMaxHitPoints(
    ::grpc::CallbackServerContext* /*context*/) {
  return nullptr;  // user must override
}
