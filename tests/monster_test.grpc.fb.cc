...
MonsterStorage::CallbackService::CallbackService() {
  AddMethod(new ::grpc::internal::CallbackUnaryHandler< MonsterStorage::CallbackService, flatbuffers::grpc::Message<Monster>, flatbuffers::grpc::Message<Stat>>(
      MonsterStorage_method_names[0],
  ...
  AddMethod(new ::grpc::internal::CallbackServerStreamingHandler< MonsterStorage::CallbackService, flatbuffers::grpc::Message<Stat>, flatbuffers::grpc::Message<Monster>>(
      MonsterStorage_method_names[1],
      [this](::grpc::CallbackServerContext* ctx, const flatbuffers::grpc::Message<Stat>* req) {
        return this->Retrieve(ctx, req);
      }));
  AddMethod(new ::grpc::internal::CallbackClientStreamingHandler< MonsterStorage::CallbackService, flatbuffers::grpc::Message<Monster>, flatbuffers::grpc::Message<Stat>>(
      MonsterStorage_method_names[2],
      [this](::grpc::CallbackServerContext* ctx, flatbuffers::grpc::Message<Stat>* resp) {
        return this->GetMaxHitPoint(ctx, resp);
      }));
  AddMethod(new ::grpc::internal::CallbackBidiHandler< MonsterStorage::CallbackService, flatbuffers::grpc::Message<Monster>, flatbuffers::grpc::Message<Stat>>(
      MonsterStorage_method_names[3],
