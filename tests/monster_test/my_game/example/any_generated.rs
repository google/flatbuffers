...
pub enum AnyT {
    NONE,
    Monster(alloc::boxed::Box<super::MonsterT>),
    TestSimpleTableWithEnum(alloc::boxed::Box<super::TestSimpleTableWithEnumT>),
    MyGameExample2Monster(alloc::boxed::Box<super::super::example_2::MonsterT>),
}
...
impl AnyT {
    ...
    pub fn take_monster(&mut self) -> Option<alloc::boxed::Box<super::MonsterT>> {
    ...
    pub fn as_monster(&self) -> Option<&super::MonsterT> {
    ...
    pub fn as_monster_mut(&mut self) -> Option<&mut super::MonsterT> {
        if let Self::Monster(v) = self { Some(v.as_mut()) } else { None }
    }

    /// If the union variant matches, return the owned super::TestSimpleTableWithEnumT, setting the union to NONE.
    pub fn take_test_simple_table_with_enum(&mut self) -> Option<alloc::boxed::Box<super::TestSimpleTableWithEnumT>> {
    ...
    /// If the union variant matches, return a reference to the super::TestSimpleTableWithEnumT.
    pub fn as_test_simple_table_with_enum(&self) -> Option<&super::TestSimpleTableWithEnumT> {
        if let Self::TestSimpleTableWithEnum(v) = self { Some(v.as_ref()) } else { None }
    }

    /// If the union variant matches, return a mutable reference to the super::TestSimpleTableWithEnumT.
    pub fn as_test_simple_table_with_enum_mut(&mut self) -> Option<&mut super::TestSimpleTableWithEnumT> {
        if let Self::TestSimpleTableWithEnum(v) = self { Some(v.as_mut()) } else { None }
    }

    /// If the union variant matches, return the owned super::super::example_2::MonsterT, setting the union to NONE.
    pub fn take_my_game_example_2_monster(&mut self) -> Option<alloc::boxed::Box<super::super::example_2::MonsterT>> {
    ...
    /// If the union variant matches, return a reference to the super::super::example_2::MonsterT.
    pub fn as_my_game_example_2_monster(&self) -> Option<&super::super::example_2::MonsterT> {
        if let Self::MyGameExample2Monster(v) = self { Some(v.as_ref()) } else { None }
    }

    /// If the union variant matches, return a mutable reference to the super::super::example_2::MonsterT.
    pub fn as_my_game_example_2_monster_mut(&mut self) -> Option<&mut super::super::example_2::MonsterT> {
