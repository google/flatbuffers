...
impl<'a> TestSimpleTableWithEnum<'a> {
    ...
    pub fn color(&self) -> super::Color {
        ...
        unsafe { self._tab.get::<super::Color>(TestSimpleTableWithEnum::VT_COLOR, Some(super::Color::Green)).unwrap()}
    }
}
...
impl<'a: 'b, 'b, A: ::flatbuffers::Allocator + 'a> TestSimpleTableWithEnumBuilder<'a, 'b, A> {
    ...
    pub fn add_color(&mut self, color: super::Color) {
        self.fbb_.push_slot::<super::Color>(TestSimpleTableWithEnum::VT_COLOR, color, super::Color::Green);
    }
