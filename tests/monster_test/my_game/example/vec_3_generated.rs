...
impl<'b> flatbuffers::Push for Vec3 {
    ...
    fn push(&self, dst: &mut [u8], _rest: &[u8]) {
        let src = unsafe {
            slice::from_raw_parts(self as *const Vec3 as *const u8, Self::size())
        };
...
impl<'a> Vec3 {
  ...
  pub fn x(&self) -> f32 {
    let mut uninit = mem::MaybeUninit::<f32>::uninit();
    unsafe {
  ...
  pub fn test1(&self) -> f64 {
    let mut uninit = mem::MaybeUninit::<f64>::uninit();
    unsafe {
      ptr::copy_nonoverlapping(
        self.0[16..].as_ptr(),
        uninit.as_mut_ptr() as *mut u8,
  ...
  pub fn test2(&self) -> Color {
    let mut uninit = mem::MaybeUninit::<Color>::uninit();
    unsafe {
      ptr::copy_nonoverlapping(
        self.0[24..].as_ptr(),
        uninit.as_mut_ptr() as *mut u8,
