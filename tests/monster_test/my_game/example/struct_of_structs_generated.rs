...
impl<'a> StructOfStructs {
    ...
    pub fn a(&self) -> &super::Ability {
        // Safety:
        // Created from a valid Table for this object
        // Which contains a valid struct in this slot
        unsafe { &*(self.0[0..].as_ptr() as *const super::Ability) }
    }

    #[allow(clippy::identity_op)]
    pub fn set_a(&mut self, x: &super::Ability) {
        self.0[0..0 + 8].copy_from_slice(&x.0)
    }

    pub fn b(&self) -> &super::Test {
        // Safety:
        // Created from a valid Table for this object
        // Which contains a valid struct in this slot
        unsafe { &*(self.0[8..].as_ptr() as *const super::Test) }
    }

    #[allow(clippy::identity_op)]
    pub fn set_b(&mut self, x: &super::Test) {
        self.0[8..8 + 4].copy_from_slice(&x.0)
    }

    pub fn c(&self) -> &super::Ability {
        // Safety:
        // Created from a valid Table for this object
        // Which contains a valid struct in this slot
        unsafe { &*(self.0[12..].as_ptr() as *const super::Ability) }
    }

    #[allow(clippy::identity_op)]
    pub fn set_c(&mut self, x: &super::Ability) {
...
pub struct StructOfStructsT {
    pub a: super::AbilityT,
    pub b: super::TestT,
    pub c: super::AbilityT,
}
