...
impl self::core::fmt::Debug for StructOfStructs {
  fn fmt(&self, f: &mut self::core::fmt::Formatter) -> self::core::fmt::Result {
...
impl<'b> flatbuffers::Push for StructOfStructs {
    ...
    fn push(&self, dst: &mut [u8], _rest: &[u8]) {
        let src = unsafe {
            self::core::slice::from_raw_parts(self as *const StructOfStructs as *const u8, Self::size())
        };
