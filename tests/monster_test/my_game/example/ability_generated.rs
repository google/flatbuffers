...
impl<'b> flatbuffers::Push for Ability {
    ...
    fn push(&self, dst: &mut [u8], _rest: &[u8]) {
        let src = unsafe {
            slice::from_raw_parts(self as *const Ability as *const u8, Self::size())
        };
...
impl<'a> Ability {
  ...
  pub fn id(&self) -> u32 {
    let mut uninit = mem::MaybeUninit::<u32>::uninit();
    unsafe {
  ...
  #[inline]
  pub fn key_compare_with_value(&self, val: u32) ->  Ordering {
    let key = self.id();
    key.cmp(&val)
  }
