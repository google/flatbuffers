...
class MonsterT(object):
    ...
    def __init__(
        ...
        self.test4 = test4  # type: List[TestT]
        self.testarrayofstring = testarrayofstring  # type: List[str]
        self.testarrayoftables = testarrayoftables  # type: List[MonsterT]
        ...
        self.testarrayofsortedstruct = testarrayofsortedstruct  # type: List[AbilityT]
        self.flex = flex  # type: List[int]
        self.test5 = test5  # type: List[TestT]
        ...
        self.vectorOfReferrables = vectorOfReferrables  # type: List[ReferrableT]
        self.singleWeakReference = singleWeakReference  # type: int
        self.vectorOfWeakReferences = vectorOfWeakReferences  # type: List[int]
        self.vectorOfStrongReferrables = vectorOfStrongReferrables  # type: List[ReferrableT]
        ...
        self.scalarKeySortedTables = scalarKeySortedTables  # type: List[StatT]
...
class TypeAliasesT(object):
    ...
    def __init__(
        ...
        self.v8 = v8  # type: List[int]
        self.vf64 = vf64  # type: List[float]
