...
impl<'a> ScalarStuff<'a> {
    ...
    #[inline]
    pub fn just_enum(&self) -> super::OptionalByte {
        // Safety:
        // Created from valid Table for this object
        // which contains a valid value in this slot
        unsafe { self._tab.get::<super::OptionalByte>(ScalarStuff::VT_JUST_ENUM, Some(super::OptionalByte::None)).unwrap()}
    }

    #[inline]
    pub fn maybe_enum(&self) -> Option<super::OptionalByte> {
        // Safety:
        // Created from valid Table for this object
        // which contains a valid value in this slot
        unsafe { self._tab.get::<super::OptionalByte>(ScalarStuff::VT_MAYBE_ENUM, None)}
    }

    #[inline]
    pub fn default_enum(&self) -> super::OptionalByte {
        // Safety:
        // Created from valid Table for this object
        // which contains a valid value in this slot
        unsafe { self._tab.get::<super::OptionalByte>(ScalarStuff::VT_DEFAULT_ENUM, Some(super::OptionalByte::One)).unwrap()}
    }
}
...
impl ::flatbuffers::Verifiable for ScalarStuff<'_> {
    ...
    fn run_verifier(
        ...
        v.visit_table(pos)?
            ...
            .visit_field::<super::OptionalByte>("just_enum", Self::VT_JUST_ENUM, false)?
            .visit_field::<super::OptionalByte>("maybe_enum", Self::VT_MAYBE_ENUM, false)?
            .visit_field::<super::OptionalByte>("default_enum", Self::VT_DEFAULT_ENUM, false)?
            .finish();
        Ok(())
    }
}
...
pub struct ScalarStuffArgs {
    ...
    pub just_enum: super::OptionalByte,
    pub maybe_enum: Option<super::OptionalByte>,
    pub default_enum: super::OptionalByte,
}
...
impl<'a> Default for ScalarStuffArgs {
    ...
    fn default() -> Self {
        ScalarStuffArgs {
            ...
            maybe_bool: None,
            default_bool: true,
            just_enum: super::OptionalByte::None,
            maybe_enum: None,
            default_enum: super::OptionalByte::One,
        }
    }
}
...
impl<'a: 'b, 'b, A: ::flatbuffers::Allocator + 'a> ScalarStuffBuilder<'a, 'b, A> {
    ...
    #[inline]
    pub fn add_just_enum(&mut self, just_enum: super::OptionalByte) {
        self.fbb_.push_slot::<super::OptionalByte>(ScalarStuff::VT_JUST_ENUM, just_enum, super::OptionalByte::None);
    }

    #[inline]
    pub fn add_maybe_enum(&mut self, maybe_enum: super::OptionalByte) {
        self.fbb_.push_slot_always::<super::OptionalByte>(ScalarStuff::VT_MAYBE_ENUM, maybe_enum);
    }

    #[inline]
    pub fn add_default_enum(&mut self, default_enum: super::OptionalByte) {
        self.fbb_.push_slot::<super::OptionalByte>(ScalarStuff::VT_DEFAULT_ENUM, default_enum, super::OptionalByte::One);
    }
