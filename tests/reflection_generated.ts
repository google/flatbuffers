...
unpack(): SchemaT {
  return new SchemaT(
    this.bb!.createObjList<Object_, ObjectT>(this.objects.bind(this), this.objectsLength()),
...
unpackTo(_o: SchemaT): void {
  _o.objects = this.bb!.createObjList<Object_, ObjectT>(this.objects.bind(this), this.objectsLength());
