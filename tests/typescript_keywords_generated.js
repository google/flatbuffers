...
import { Schema as reflectionSchema } from './reflection_generated';
...
export class Object_ {
    ...
    unpack() {
        return new ObjectT(this.return(), this.if(), this.switch(), this.enum(), this.enum2(), this.enum3(), (this.reflect() !== null ? this.reflect().unpack() : null));
    }
    unpackTo(_o) {
...
export class ObjectT {
    constructor(return_ = 0, if_ = 0, switch_ = 0, enum_ = class_.new_, enum2 = foobarclass_.arguments_, enum3 = foobarAbc.a, reflect = null) {
