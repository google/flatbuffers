...
struct RootTable FLATBUFFERS_FINAL_CLASS : private ::flatbuffers::Table {
  ...
  bool Verify(::flatbuffers::VerifierTemplate<B>& verifier) const {
    return VerifyTableStart(verifier) &&
           ...
           verifier.template VerifyNestedFlatBuffer<RootTable>(nested_root(),
                                                               nullptr) &&
...
inline ::flatbuffers::Offset<RootTable> CreateRootTable(
    ...
    ::flatbuffers::Offset64<::flatbuffers::Vector64<uint8_t>> big_bool_vector =
        0,
...
inline ::flatbuffers::Offset<RootTable> CreateRootTableDirect(
  ...
  auto big_bool_vector__ =
      big_bool_vector ? _fbb.CreateVector64(*big_bool_vector) : 0;
  ...
  auto many_vectors__ =
      many_vectors ? _fbb.CreateVector<::flatbuffers::Offset<WrapperTable>>(
                         *many_vectors)
                   : 0;
  return CreateRootTable(_fbb, far_vector__, a, far_string__, big_bool_vector__,
                         big_vector__, near_string__, nested_root__,
                         far_struct_vector__, big_struct_vector__,
                         many_vectors__, forced_aligned_vector__);
}
...
inline void RootTable::UnPackTo(
  ...
  {
    auto _e = big_bool_vector();
    if (_e) {
      _o->big_bool_vector.resize(_e->size());
      std::copy(_e->begin(), _e->end(), _o->big_bool_vector.begin());
    }
  }
  {
    auto _e = big_vector();
...
inline ::flatbuffers::Offset<RootTable> RootTable::Pack(
  ...
  auto _big_bool_vector =
      _o->big_bool_vector.size() ? _fbb.CreateVector64(_o->big_bool_vector) : 0;
  auto _big_vector =
  ...
  auto _forced_aligned_vector =
      _o->forced_aligned_vector.size()
          ...
          : 0;
  return CreateRootTable(_fbb, _far_vector, _a, _far_string, _big_bool_vector,
                         _big_vector, _near_string, _nested_root,
                         _far_struct_vector, _big_struct_vector, _many_vectors,
...
inline const ::flatbuffers::TypeTable* RootTableTypeTable() {
  static const ::flatbuffers::TypeCode type_codes[] = {
      ...
      {::flatbuffers::ET_UCHAR, 1, -1},   {::flatbuffers::ET_STRING, 0, -1},
      {::flatbuffers::ET_UCHAR, 1, -1},   {::flatbuffers::ET_SEQUENCE, 1, 0},
  ...
  static const char* const names[] = {
      "far_vector",           "a",
      "far_string",           "big_bool_vector",
      "big_vector",           "near_string",
      "nested_root",          "far_struct_vector",
...
inline bool VerifySizePrefixedRootTableBuffer(
    ::flatbuffers::VerifierTemplate<B>& verifier) {
  return verifier
      .template VerifySizePrefixedBuffer<RootTable, ::flatbuffers::uoffset64_t>(
          nullptr);
}
