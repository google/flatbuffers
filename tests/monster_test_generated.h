...
struct MonsterBuilder {
  ...
  void add_testarrayofbytes(flatbuffers::Offset<flatbuffers::Vector<int8_t>> testarrayofbytes) { fbb_.AddOffset(Monster::VT_TESTARRAYOFBYTES, testarrayofbytes); }
  void add_testarrayofshort(flatbuffers::Offset<flatbuffers::Vector<int16_t>> testarrayofshort) { fbb_.AddOffset(Monster::VT_TESTARRAYOFSHORT, testarrayofshort); }
  void add_testarrayofushort(flatbuffers::Offset<flatbuffers::Vector<uint16_t>> testarrayofushort) { fbb_.AddOffset(Monster::VT_TESTARRAYOFUSHORT, testarrayofushort); }
  void add_testarrayofint(flatbuffers::Offset<flatbuffers::Vector<int32_t>> testarrayofint) { fbb_.AddOffset(Monster::VT_TESTARRAYOFINT, testarrayofint); }
  void add_testarrayofuint(flatbuffers::Offset<flatbuffers::Vector<uint32_t>> testarrayofuint) { fbb_.AddOffset(Monster::VT_TESTARRAYOFUINT, testarrayofuint); }
  void add_testarrayoflong(flatbuffers::Offset<flatbuffers::Vector<int64_t>> testarrayoflong) { fbb_.AddOffset(Monster::VT_TESTARRAYOFLONG, testarrayoflong); }
  void add_testarrayofulong(flatbuffers::Offset<flatbuffers::Vector<uint64_t>> testarrayofulong) { fbb_.AddOffset(Monster::VT_TESTARRAYOFULONG, testarrayofulong); }
  void add_testarrayoffloat(flatbuffers::Offset<flatbuffers::Vector<float>> testarrayoffloat) { fbb_.AddOffset(Monster::VT_TESTARRAYOFFLOAT, testarrayoffloat); }
  void add_testarrayofdouble(flatbuffers::Offset<flatbuffers::Vector<double>> testarrayofdouble) { fbb_.AddOffset(Monster::VT_TESTARRAYOFDOUBLE, testarrayofdouble); }
  void add_testdouble(double testdouble) { fbb_.AddElement<double>(Monster::VT_TESTDOUBLE, testdouble, 0.0); }
  void add_testbyte(int8_t testbyte) { fbb_.AddElement<int8_t>(Monster::VT_TESTBYTE, testbyte, 0); }
  void add_testubyte(uint8_t testubyte) { fbb_.AddElement<uint8_t>(Monster::VT_TESTUBYTE, testubyte, 0); }
  MonsterBuilder(flatbuffers::FlatBufferBuilder &_fbb) : fbb_(_fbb) { start_ = fbb_.StartTable(); }
  MonsterBuilder &operator=(const MonsterBuilder &);
  flatbuffers::Offset<Monster> Finish() {
