...
class GuardedMonster : private MonsterT {
 ...
 public:
  ...
  auto name() -> decltype(Parent::name)&{ return Parent::name; }
  auto name() const -> const decltype(Parent::name)&{ return Parent::name; }
  ...
  bool push_vec_of_structs_with_max(Test const& value) {
    if (Parent::vec_of_structs_with_max.size() >= 9)
        return false;
  ...
  bool push_vec_of_strings_with_max(std::string const& value) {
    if (Parent::vec_of_strings_with_max.size() >= 12)
        return false;
  ...
  bool push_vec_of_non_owning_references_with_max(ReferrableT *  value) {
    if (Parent::vec_of_non_owning_references_with_max.size() >= 24)
        return false;
  ...
  bool push_vec_of_enums_with_max(Color  value) {
    if (Parent::vec_of_enums_with_max.size() >= 2)
        return false;
...
inline const flatbuffers::TypeTable *MonsterTypeTable() {
  ...
  static const flatbuffers::TypeTable tt = {
    flatbuffers::ST_TABLE, 55, type_codes, type_refs, nullptr, names
  };
  return &tt;
}
