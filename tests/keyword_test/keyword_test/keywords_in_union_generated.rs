...
pub enum KeywordsInUnionT {
    NONE,
    Static_(alloc::boxed::Box<super::KeywordsInTableT>),
    Internal(alloc::boxed::Box<super::KeywordsInTableT>),
}
...
impl KeywordsInUnionT {
    ...
    /// If the union variant matches, return the owned super::KeywordsInTableT, setting the union to NONE.
    pub fn take_static_(&mut self) -> Option<alloc::boxed::Box<super::KeywordsInTableT>> {
    ...
    /// If the union variant matches, return a mutable reference to the super::KeywordsInTableT.
    pub fn as_static__mut(&mut self) -> Option<&mut super::KeywordsInTableT> {
        if let Self::Static_(v) = self { Some(v.as_mut()) } else { None }
    }

    /// If the union variant matches, return the owned super::KeywordsInTableT, setting the union to NONE.
    pub fn take_internal(&mut self) -> Option<alloc::boxed::Box<super::KeywordsInTableT>> {
    ...
    /// If the union variant matches, return a reference to the super::KeywordsInTableT.
    pub fn as_internal(&self) -> Option<&super::KeywordsInTableT> {
