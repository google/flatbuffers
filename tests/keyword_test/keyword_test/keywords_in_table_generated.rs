...
impl<'a> KeywordsInTable<'a> {
  ...
  pub fn type_(&self) -> i32 {
    self._tab.get::<i32>(KeywordsInTable::VT_TYPE, Some(0)).unwrap()
  }
}
...
impl flatbuffers::Verifiable for KeywordsInTable<'_> {
  ...
  fn run_verifier(
    ...
    v.visit_table(pos)?
     ...
     .visit_field::<i32>("type_", Self::VT_TYPE, false)?
     .finish();
    Ok(())
  }
}
...
impl<'a: 'b, 'b> KeywordsInTableBuilder<'a, 'b> {
  ...
  pub fn add_type_(&mut self, type_: i32) {
    self.fbb_.push_slot::<i32>(KeywordsInTable::VT_TYPE, type_, 0);
  }
  #[inline]
