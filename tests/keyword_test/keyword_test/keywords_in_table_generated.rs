...
impl<'a> KeywordsInTable<'a> {
    ...
    #[inline]
    pub fn is(&self) -> super::ABC {
        // Safety:
        // Created from valid Table for this object
        // which contains a valid value in this slot
        unsafe { self._tab.get::<super::ABC>(KeywordsInTable::VT_IS, Some(super::ABC::void)).unwrap()}
    }

    #[inline]
    pub fn private(&self) -> super::public {
        // Safety:
        // Created from valid Table for this object
        // which contains a valid value in this slot
        unsafe { self._tab.get::<super::public>(KeywordsInTable::VT_PRIVATE, Some(super::public::NONE)).unwrap()}
    }
...
impl ::flatbuffers::Verifiable for KeywordsInTable<'_> {
    ...
    fn run_verifier(
        ...
        v.visit_table(pos)?
            .visit_field::<super::ABC>("is", Self::VT_IS, false)?
            .visit_field::<super::public>("private", Self::VT_PRIVATE, false)?
...
impl<'a: 'b, 'b, A: ::flatbuffers::Allocator + 'a> KeywordsInTableBuilder<'a, 'b, A> {
    ...
    pub fn add_is(&mut self, is: super::ABC) {
        self.fbb_.push_slot::<super::ABC>(KeywordsInTable::VT_IS, is, super::ABC::void);
    }

    #[inline]
    pub fn add_private(&mut self, private: super::public) {
        self.fbb_.push_slot::<super::public>(KeywordsInTable::VT_PRIVATE, private, super::public::NONE);
    }
