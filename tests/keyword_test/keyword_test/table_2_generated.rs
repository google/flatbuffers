...
impl<'a> Table2<'a> {
    ...
    pub fn type_type(&self) -> KeywordsInUnion {
        ...
        unsafe { self.tab.get::<KeywordsInUnion>(Table2::VT_TYPE_TYPE, Some(KeywordsInUnion::NONE)).unwrap()}
    }
    ...
    pub fn type_(&self) -> Option<::flatbuffers::Table<'a>> {
        ...
        // Created from valid Table for this object
        // which contains a valid value in this slot
        unsafe { self.tab.get::<::flatbuffers::ForwardsUOffset<::flatbuffers::Table<'a>>>(Table2::VT_TYPE_, None)}
    }
...
impl Table2T {
    ...
    pub fn pack<'b, A: ::flatbuffers::Allocator + 'b>(
        ...
        let type_ = self.type_.pack(fbb);
        debug_assert!(type_.is_some() || type_type == KeywordsInUnion::NONE, "Union discriminant does not match packed value");
        Table2::create(fbb, &Table2Args{
            type_type,
            type_,
        })
    }
