 ...
 */
export async function computeSchemaHash(bfbsData) {
 ...
 */
export function envelopeWrap(schemaHash, payload) {
 ...
 */
export function envelopeUnwrap(data, expectedHash) {
 ...
 */
export function envelopePayload(data) {
    const parsed = parseEnvelope(data);
 ...
 *          header is malformed.
 */
export function envelopeSchemaHash(data) {
    const parsed = parseEnvelope(data);
