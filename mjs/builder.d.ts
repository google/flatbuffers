...
export declare class Builder {
    ...
    addFieldInt8(voffset: number, value: number, defaultValue: number | null | undefined): void;
    addFieldInt16(voffset: number, value: number, defaultValue: number | null | undefined): void;
    addFieldInt32(voffset: number, value: number, defaultValue: number | null | undefined): void;
    addFieldInt64(voffset: number, value: bigint, defaultValue: bigint | null | undefined): void;
    addFieldFloat32(voffset: number, value: number, defaultValue: number | null | undefined): void;
    addFieldFloat64(voffset: number, value: number, defaultValue: number | null | undefined): void;
