...
def FieldAddDefaultString(builder, defaultString): builder.PrependUOffsetTRelativeSlot(6, flatbuffers.number_types.UOffsetTFlags.py_type(defaultString), 0)
def AddDefaultString(builder, defaultString):
    return FieldAddDefaultString(builder, defaultString)
def FieldAddDeprecated(builder, deprecated): builder.PrependBoolSlot(7, deprecated, 0)
def AddDeprecated(builder, deprecated):
    return FieldAddDeprecated(builder, deprecated)
def FieldAddRequired(builder, required): builder.PrependBoolSlot(8, required, 0)
def AddRequired(builder, required):
    return FieldAddRequired(builder, required)
def FieldAddKey(builder, key): builder.PrependBoolSlot(9, key, 0)
def AddKey(builder, key):
    return FieldAddKey(builder, key)
def FieldAddAttributes(builder, attributes): builder.PrependUOffsetTRelativeSlot(10, flatbuffers.number_types.UOffsetTFlags.py_type(attributes), 0)
...
def FieldAddDocumentation(builder, documentation): builder.PrependUOffsetTRelativeSlot(11, flatbuffers.number_types.UOffsetTFlags.py_type(documentation), 0)
...
def FieldAddOptional(builder, optional): builder.PrependBoolSlot(12, optional, 0)
def AddOptional(builder, optional):
    return FieldAddOptional(builder, optional)
def FieldAddPadding(builder, padding): builder.PrependUint16Slot(13, padding, 0)
