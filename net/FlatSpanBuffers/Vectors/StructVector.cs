...
namespace Google.FlatSpanBuffers.Vectors
{
        ...
        where T : struct, IFlatbufferObject
    {
        ...
        public StructVector(Table p, int offset, int elementSize)
        {
    ...
    public ref struct StructVectorSpan<T>
        where T : struct, IFlatbufferSpanObject, allows ref struct
    {
        ...
        public StructVectorSpan(TableSpan p, int offset, int elementSize)
        {
