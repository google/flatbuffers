...
public ref struct Bar : IFlatbufferSpanObject
{
  ...
  public Bar __assign(int _i, ByteSpanBuffer _bb) { __init(_i, _bb); return this; }

  public Benchmarks.FlatSpanBuffers.StackBuffer.Foo Parent { get { return (new Benchmarks.FlatSpanBuffers.StackBuffer.Foo()).__assign(__p.bb_pos + 0, __p.bb); } }
  ...
  public static Offset<Benchmarks.FlatSpanBuffers.StackBuffer.Bar> CreateBar(ref FlatSpanBufferBuilder builder, ulong parent_Id, short parent_Count, sbyte parent_Prefix, uint parent_Length, int Time, float Ratio, ushort Size) {
    builder.Prep(8, 32);
    builder.Pad(6);
    ...
    return new Offset<Benchmarks.FlatSpanBuffers.StackBuffer.Bar>(builder.Offset);
  }
  public BarT UnPack() {
    var _o = new BarT();
    this.UnPackTo(_o);
