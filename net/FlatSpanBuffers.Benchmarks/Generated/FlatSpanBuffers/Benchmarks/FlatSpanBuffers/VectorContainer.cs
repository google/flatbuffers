...
public struct VectorContainer : IFlatbufferObject
{
  ...
  public static VectorContainer GetRootAsVectorContainer(ByteBuffer _bb, VectorContainer obj) { return (obj.__assign(_bb.Get<int>(_bb.Position) + _bb.Position, _bb)); }
  ...
  public StringVector? Strings { get { int o = __p.__offset(16); return o != 0 ? new StringVector(__p, o) : null; } }

  public static Offset<Benchmarks.FlatSpanBuffers.VectorContainer> CreateVectorContainer(FlatBufferBuilder builder,
  ...
  public static Offset<Benchmarks.FlatSpanBuffers.VectorContainer> EndVectorContainer(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Benchmarks.FlatSpanBuffers.VectorContainer>(o);
  }
  ...
  public static Offset<Benchmarks.FlatSpanBuffers.VectorContainer> Pack(FlatBufferBuilder builder, VectorContainerT _o) {
    ...
    if (_o.Shorts != null) {
      _shorts = CreateShortsVector(builder, CollectionsMarshal.AsSpan(_o.Shorts));
    }
    var _ints = default(VectorOffset);
    if (_o.Ints != null) {
      _ints = CreateIntsVector(builder, CollectionsMarshal.AsSpan(_o.Ints));
    }
    var _longs = default(VectorOffset);
    if (_o.Longs != null) {
      _longs = CreateLongsVector(builder, CollectionsMarshal.AsSpan(_o.Longs));
    }
    var _floats = default(VectorOffset);
    if (_o.Floats != null) {
      _floats = CreateFloatsVector(builder, CollectionsMarshal.AsSpan(_o.Floats));
    }
    var _doubles = default(VectorOffset);
    if (_o.Doubles != null) {
      _doubles = CreateDoublesVector(builder, CollectionsMarshal.AsSpan(_o.Doubles));
    }
