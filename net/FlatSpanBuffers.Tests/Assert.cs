...
namespace Google.FlatSpanBuffers.Tests
{
    ...
    public static class Assert
    {
        ...
        public static void AreEqual<T>(T expected, T actual, int precision) where T : IComparable<T>
        {
            ...
            {
                var expectedDouble = (double)(object)expected!;
                var actualDouble = (double)(object)actual!;
        ...
        public static void NotEqual<T>(T notExpected, T actual)
        {
            ...
            if (notExpected == null && actual == null)
                areEqual = true;
            else if (notExpected != null && actual != null && notExpected.Equals(actual))
                areEqual = true;
                
            if (areEqual)
            {
                throw new AssertFailedException($"Not {notExpected}", actual!);
            }
        }
            ...
            where T : IEquatable<T>
        {
            ...
            {
                throw new AssertFailedException($"Expected length {expected.Length}", $"Actual length {actual.Length}");
            }
            ...
            for (var i = 0; i < expected.Length; ++i)
            {
                ...
                {
                    throw new AssertArrayFailedException(i, expected[i], actual[i]);
                }
            }
        }
        ...
        public static void IsNull<T>(T value)
        {
            if (value != null)
            {
                throw new AssertFailedException("<null>", value);
            }
        }
        ...
        public static void IsNotNull<T>(T value)
        {
            if (value == null)
            {
                throw new AssertFailedException("not null", "<null>");
            }
        }
