...
namespace Google.FlatSpanBuffers.Tests
{
    ...
    public class FlatBuffersFuzzTests
    {
        ...
        public void TestNumbers()
        {
            ...
            expected = [1];
            Assert.SpanEqual<byte>(expected, builder.DataBuffer.ToSpan(0, expected.Length));
            builder.Add<sbyte>(-127);
            expected = [129, 1];
            Assert.SpanEqual<byte>(expected, builder.DataBuffer.ToSpan(0, expected.Length));
            builder.Add<byte>(255);
            expected = [0, 255, 129, 1]; // First pad
            Assert.SpanEqual<byte>(expected, builder.DataBuffer.ToSpan(0, expected.Length));
            builder.Add<short>(-32222);
            expected = [0, 0, 0x22, 0x82, 0, 255, 129, 1]; // Second pad
            Assert.SpanEqual<byte>(expected, builder.DataBuffer.ToSpan(0, expected.Length));
            builder.Add<ushort>(0xFEEE);
            expected = [0xEE, 0xFE, 0x22, 0x82, 0, 255, 129, 1]; // no pad
            Assert.SpanEqual<byte>(expected, builder.DataBuffer.ToSpan(0, expected.Length));
            builder.Add<int>(-53687092);
            expected = [0, 0, 0, 0, 204, 204, 204, 252, 0xEE, 0xFE, 0x22, 0x82, 0, 255, 129, 1]; // third pad
            Assert.SpanEqual<byte>(expected, builder.DataBuffer.ToSpan(0, expected.Length));
            builder.Add<uint>(0x98765432);
            expected = [0x32, 0x54, 0x76, 0x98, 204, 204, 204, 252, 0xEE, 0xFE, 0x22, 0x82, 0, 255, 129, 1]; // no pad
            Assert.SpanEqual<byte>(expected, builder.DataBuffer.ToSpan(0, expected.Length));
        }
        ...
        {
            var builder = new FlatBufferBuilder(1);
            builder.Add<ulong>(0x1122334455667788);
            byte[] expected = [0x88, 0x77, 0x66, 0x55, 0x44, 0x33, 0x22, 0x11];
            Assert.SpanEqual<byte>(expected, builder.DataBuffer.ToSpan(0, expected.Length));

            builder = new FlatBufferBuilder(1);
            builder.Add<long>(0x1122334455667788);
        ...
        public void TestVector_2xUint8()
        {
            ...
            Assert.SpanEqual<byte>(expected, builder.DataBuffer.ToSpan(0, expected.Length));
            builder.Add<byte>(2);
            expected = [0, 0, 0, 0, 2, 1, 0, 0];
            Assert.SpanEqual<byte>(expected, builder.DataBuffer.ToSpan(0, expected.Length));
            builder.EndVector();
            expected = [2, 0, 0, 0, 2, 1, 0, 0];
            Assert.SpanEqual<byte>(expected, builder.DataBuffer.ToSpan(0, expected.Length));
        }
        ...
        public void TestVector_2xUInt16()
        {
            ...
            byte[] expected = [0, 0, 0, 0, 0, 0, 0, 0];
            Assert.SpanEqual<byte>(expected, builder.DataBuffer.ToSpan(0, expected.Length));
            builder.Add<ushort>(0xABCD);
            expected = [0, 0, 0, 0, 0, 0, 0xCD, 0xAB];
            Assert.SpanEqual<byte>(expected, builder.DataBuffer.ToSpan(0, expected.Length));
            builder.Add<ushort>(0xDCBA);
            expected = [0, 0, 0, 0, 0xBA, 0xDC, 0xCD, 0xAB];
            Assert.SpanEqual<byte>(expected, builder.DataBuffer.ToSpan(0, expected.Length));
            builder.EndVector();
            expected = [2, 0, 0, 0, 0xBA, 0xDC, 0xCD, 0xAB];
            Assert.SpanEqual<byte>(expected, builder.DataBuffer.ToSpan(0, expected.Length));
        }
        ...
        public void TestCreateAsciiString()
        {
            ...
            byte[] expected = [3, 0, 0, 0, (byte)'f', (byte)'o', (byte)'o', 0];
            Assert.SpanEqual<byte>(expected, builder.DataBuffer.ToSpan(0, expected.Length));
        ...
        public void TestCreateSharedAsciiString()
        {
            ...
            builder.CreateSharedString("foo");
            expected = [3, 0, 0, 0, (byte)'f', (byte)'o', (byte)'o', 0];
            Assert.SpanEqual<byte>(expected, builder.DataBuffer.ToSpan(0, expected.Length));
        }

        [FlatBuffersTestMethod]
        public void TestCreateArbitraryString()
        {
            var builder = new FlatBufferBuilder(1);
    ...
    [FlatBuffersTestMethod]
        public void TestVTableWithOneBool_DefaultValue()
        {
            ...
            byte[] expected = [0];
            Assert.SpanEqual<byte>(expected, builder.DataBuffer.ToSpan(0, expected.Length));
            builder.Add<bool>(0, false, false);
            builder.EndTable();
            expected =
            [
                // No padding.
        ...
        public void TestVTableWithTwoInt16()
        {
            ...
            byte[] expected = [0];
            Assert.SpanEqual<byte>(expected, builder.DataBuffer.ToSpan(0, expected.Length));
            builder.Add<short>(0, 0x3456, 0);
            builder.Add<short>(1, 0x789A, 0);
            int offset = builder.EndTable();
            expected =
            [
                8, 0, // vtable bytes
        ...
        public void TestVTableWith_1xInt16_and_Vector_or_2xInt16()
        {
            ...
            builder.Add<short>(0x1234);
            builder.Add<short>(0x5678);
            var vecEnd = builder.EndVector();
        ...
        public void TestVTableWithAStruct_of_int8_int16_int32()
        {
            ...
            builder.Add<sbyte>(55);
            builder.Pad(3);
            builder.Add<short>(0x1234);
            builder.Pad(2);
            builder.Add<int>(0x12345678);
            var structStart = builder.Offset;
            builder.AddStruct(0, structStart, 0);
            builder.EndTable();

            // Actual buffer data (22 bytes of data + 2 bytes padding = 24 bytes total)
            byte[] expected =
            [
                0, 0, // Padding to align to buffer size
                6, 0, // vtable bytes
                16, 0, // object length
            ...
            Assert.SpanEqual<byte>(expected, builder.DataBuffer.ToSpan(0, expected.Length));
            var verifier = new Verifier(builder.DataBuffer);
            uint checkOffset = 8; // 2 bytes padding + 6 bytes vtable = 8 bytes to table start
            // table must be ok
            Assert.IsTrue(verifier.VerifyTableStart(checkOffset));
        ...
        public void TestVTableWithSomeElements()
        {
            var builder = new FlatBufferBuilder(1);
            builder.StartTable(2);
            builder.Add<byte>(0, 33, 0);
            builder.Add<short>(1, 66, 0);
            ...
            Assert.SpanEqual<byte>(padded, builder.DataBuffer.ToSpan(0, padded.Length));

            // no padding in sized array
            byte[] unpadded = new byte[padded.Length - 12];
            System.Buffer.BlockCopy(padded, 12, unpadded, 0, unpadded.Length);
            Assert.SpanEqual<byte>(unpadded, builder.DataBuffer.ToSizedSpan());

            var verifier = new Verifier(builder.DataBuffer);
            uint checkOffset = builder.DataBuffer.Get<uint>(builder.DataBuffer.Position) + (uint)builder.DataBuffer.Position;
            // table must be ok
            Assert.IsTrue(verifier.VerifyTableStart(checkOffset));
            // First field must be a struct with 12 bytes
...
//// builder.AddOffsetSpan([str1.Value, str2.Value]); // add multiple offsets at a time.
        [FlatBuffersTestMethod]
        public void TestVTableWithVectorOfStrings()
        {
            ...
            builder.AddOffsetSpan([str2.Value, str1.Value]); // add multiple offsets at a time.
        ...
        public void TestTwoFinishTable()
        {
            ...
            builder.StartTable(2);
            builder.Add<byte>(0, 33, 0);
            builder.Add<byte>(1, 44, 0);
            var off0 = builder.EndTable();
            builder.Finish(off0);

            builder.StartTable(3);
            builder.Add<byte>(0, 55, 0);
            builder.Add<byte>(1, 66, 0);
            builder.Add<byte>(2, 77, 0);
            ...
            Assert.SpanEqual<byte>(expected, builder.DataBuffer.ToSpan(0, builder.DataBuffer.Length));
        ...
        public void TestBunchOfBools()
        {
            ...
            System.Buffer.BlockCopy(padded, 28, unpadded, 0, unpadded.Length);
            Assert.SpanEqual<byte>(unpadded, builder.DataBuffer.ToSizedSpan());
        ...
        public void TestBunchOfBoolsSizePrefixed()
        {
            ...
            System.Buffer.BlockCopy(padded, 24, unpadded, 0, unpadded.Length);
            Assert.SpanEqual<byte>(unpadded, builder.DataBuffer.ToSizedSpan());
        }
        ...
        private void CheckObjects(int fieldCount, int objectCount)
        {
            ...
            var vtableWorkspace = new int[fieldCount];
            var vtableOffsetWorkspace = new int[objectCount];
            var builder = new FlatBufferBuilder(bb, vtableWorkspace, vtableOffsetWorkspace);
            ...
            for (var i = 0; i < objectCount; ++i)
            {
                ...
                for (var j = 0; j < fieldCount; ++j)
                {
                    ...
                    switch (fieldType)
                    {
                        case 0:
                        {
                            builder.Add<bool>(j, FuzzTestData.BoolValue, false);
                            break;
                        }
                        case 1:
                        {
                            builder.Add<sbyte>(j, FuzzTestData.Int8Value, 0);
                            break;
                        }
                        case 2:
                        {
                            builder.Add<byte>(j, FuzzTestData.UInt8Value, 0);
                            break;
                        }
                        case 3:
                        {
                            builder.Add<short>(j, FuzzTestData.Int16Value, 0);
                            break;
                        }
                        case 4:
                        {
                            builder.Add<ushort>(j, FuzzTestData.UInt16Value, 0);
                            break;
                        }
                        case 5:
                        {
                            builder.Add<int>(j, FuzzTestData.Int32Value, 0);
                            break;
                        }
                        case 6:
                        {
                            builder.Add<uint>(j, FuzzTestData.UInt32Value, 0);
                            break;
                        }
                        case 7:
                        {
                            builder.Add<long>(j, FuzzTestData.Int64Value, 0);
                            break;
                        }
                        case 8:
                        {
                            builder.Add<ulong>(j, FuzzTestData.UInt64Value, 0);
                            break;
                        }
                        case 9:
                        {
                            builder.Add<float>(j, FuzzTestData.Float32Value, 0);
                            break;
                        }
                        case 10:
                        {
                            builder.Add<double>(j, FuzzTestData.Float64Value, 0);
                            break;
                        }
                        default:
