...
// Load file "name" into "lines" vector returning true if successful
// false otherwise. This will push each line in the specified file to
// the lines output vector. The vector will be appended to so ensure
// the vector is clear if only this file content is needed.
