...
#define FLATBUFFERS_GEN_TYPES_POINTER(TD) \
  TD(STRING, "string", Offset<void>, int, int, StringOffset, int, unused, Int, Int) \
  TD(VECTOR, "",       Offset<void>, int, int, VectorOffset, int, unused, Int, Int) \
  TD(STRUCT, "",       Offset<void>, int, int, int,          int, unused, Int, Int) \
  TD(UNION,  "",       Offset<void>, int, int, int,          int, unused, Int, Int)
#define FLATBUFFERS_GEN_TYPE_ARRAY(TD) \
  TD(ARRAY,  "",       int,          int, int, int,          int, unused, Int, Int)
// The fields are:
// - enum
