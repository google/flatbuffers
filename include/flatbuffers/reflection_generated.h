...
struct Field FLATBUFFERS_FINAL_CLASS : private ::flatbuffers::Table {
  ...
  bool Verify(::flatbuffers::VerifierTemplate<B>& verifier) const {
    return VerifyTableStart(verifier) &&
           ...
           verifier.VerifyString(default_non_scalar()) && verifier.EndTable();
  }
};
...
struct FieldBuilder {
  ...
  void add_default_non_scalar(
      ::flatbuffers::Offset<::flatbuffers::String> default_non_scalar) {
...
inline ::flatbuffers::Offset<Field> CreateFieldDirect(
  ...
  auto default_non_scalar__ =
      default_non_scalar ? _fbb.CreateString(default_non_scalar) : 0;
...
template <bool B = false>
inline bool VerifySchemaBuffer(::flatbuffers::VerifierTemplate<B>& verifier) {
...
inline bool VerifySizePrefixedSchemaBuffer(
  ...
  return verifier.template VerifySizePrefixedBuffer<reflection::Schema>(
      SchemaIdentifier());
}
