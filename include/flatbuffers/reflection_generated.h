...
struct FieldBuilder {
  ...
  void add_default_string(
      flatbuffers::Offset<flatbuffers::String> default_string) {
...
inline flatbuffers::Offset<Field> CreateFieldDirect(
    ...
    flatbuffers::Offset<reflection::Type> type = 0, uint16_t id = 0,
    uint16_t offset = 0, int64_t default_integer = 0, double default_real = 0.0,
    const char *default_string = nullptr, bool deprecated = false,
  ...
  auto default_string__ =
      default_string ? _fbb.CreateString(default_string) : 0;
  auto attributes__ =
      attributes
          ? _fbb.CreateVectorOfSortedTables<reflection::KeyValue>(attributes)
          : 0;
  ...
  return reflection::CreateField(
      _fbb, name__, type, id, offset, default_integer, default_real,
      default_string__, deprecated, required, key, attributes__,
      documentation__, optional, padding);
}
