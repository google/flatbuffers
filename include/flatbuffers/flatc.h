...
// extern std::unique_ptr<flatbuffers::CodeGenerator>
// NewJsonSchemaCodeGenerator(); extern
// std::unique_ptr<flatbuffers::CodeGenerator> NewDartCodeGenerator(); extern
// std::unique_ptr<flatbuffers::CodeGenerator> NewLuaCodeGenerator(); extern
// std::unique_ptr<flatbuffers::CodeGenerator> NewLobsterCodeGenerator(); extern
// std::unique_ptr<flatbuffers::CodeGenerator> NewRustCodeGenerator(); extern
// std::unique_ptr<flatbuffers::CodeGenerator> NewKotlinCodeGenerator(); extern
// std::unique_ptr<flatbuffers::CodeGenerator> NewSwiftCodeGenerator();
