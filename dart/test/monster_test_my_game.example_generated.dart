...
class Monster {
  ...
  dynamic get test {
    switch (testType?.value) {
      ...
      case 3: return MyGame_Example2_Monster.reader.vTableGet(_bc, _bcOffset, 20, null);
      default: return null;
    }
  }
...
class MonsterObjectBuilder extends fb.ObjectBuilder {
  ...
  int finish(
    ...
    final int test5Offset = _test5?.isNotEmpty == true
        ...
        : null;
    final int vector_of_longsOffset = _vectorOfLongs?.isNotEmpty == true
        ? fbBuilder.writeListInt64(_vectorOfLongs)
        : null;
    final int vector_of_doublesOffset = _vectorOfDoubles?.isNotEmpty == true
        ? fbBuilder.writeListFloat64(_vectorOfDoubles)
        : null;
    final int parent_namespace_testOffset = _parentNamespaceTest?.getOrCreateOffset(fbBuilder);
    final int vector_of_referrablesOffset = _vectorOfReferrables?.isNotEmpty == true
        ? fbBuilder.writeList(_vector_of_referrables.map((b) => b.getOrCreateOffset(fbBuilder)).toList())
        : null;
    final int vector_of_weak_referencesOffset = _vectorOfWeakReferences?.isNotEmpty == true
        ? fbBuilder.writeListUint64(_vectorOfWeakReferences)
        : null;
    final int vector_of_strong_referrablesOffset = _vectorOfStrongReferrables?.isNotEmpty == true
        ? fbBuilder.writeList(_vector_of_strong_referrables.map((b) => b.getOrCreateOffset(fbBuilder)).toList())
        : null;
    final int vector_of_co_owning_referencesOffset = _vectorOfCoOwningReferences?.isNotEmpty == true
        ? fbBuilder.writeListUint64(_vectorOfCoOwningReferences)
        : null;
    final int vector_of_non_owning_referencesOffset = _vectorOfNonOwningReferences?.isNotEmpty == true
