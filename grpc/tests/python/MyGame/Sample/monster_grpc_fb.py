...
import Monster_fb as Monster__fb
import Weapon_fb as Weapon__fb
...
class MonsterStorageStub(object):
  ...
  def __init__(self, channel):
    ...
    self.Store = channel.unary_unary(
        ...
        response_deserializer=Weapon.FromString,
        )
    self.Retrieve = channel.unary_unary(
        '/MyGame.Sample.MonsterStorage/Retrieve',
        request_serializer=Weapon.SerializeToString,
...
def add_MonsterStorageServicer_to_server(servicer, server):
  rpc_method_handlers = {
      'Store': grpc.unary_unary_rpc_method_handler(
          ...
          response_serializer=Weapon.SerializeToString,
      ),
      'Retrieve': grpc.unary_unary_rpc_method_handler(
          servicer.Retrieve,
          request_deserializer=Weapon.FromString,
...
try:
  ...
  def beta_create_MonsterStorage_server(servicer, pool=None, pool_size=None, default_timeout=None, maximum_timeout=None):
    ...
    request_deserializers = {
      ('MyGame.Sample.MonsterStorage', 'Retrieve'): Weapon.FromString,
      ('MyGame.Sample.MonsterStorage', 'Store'): Monster.FromString,
    }
    response_serializers = {
      ('MyGame.Sample.MonsterStorage', 'Retrieve'): Monster.SerializeToString,
      ('MyGame.Sample.MonsterStorage', 'Store'): Weapon.SerializeToString,
    }
  ...
  def beta_create_MonsterStorage_stub(channel, host=None, metadata_transformer=None, pool=None, pool_size=None):
    ...
    generated only to ease transition from grpcio<0.15.0 to grpcio>=0.15.0"""
    request_serializers = {
      ('MyGame.Sample.MonsterStorage', 'Retrieve'): Weapon.SerializeToString,
      ('MyGame.Sample.MonsterStorage', 'Store'): Monster.SerializeToString,
    }
    response_deserializers = {
      ('MyGame.Sample.MonsterStorage', 'Retrieve'): Monster.FromString,
      ('MyGame.Sample.MonsterStorage', 'Store'): Weapon.FromString,
    }
    cardinalities = {
