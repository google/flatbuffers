...
namespace grpc_java_generator {
    ...
    void GenerateImports(grpc_generator::File *file, grpc_generator::Printer *printer, VARS& vars) {
        ...
        printer->Print(vars, "//Generated by flatc compiler (version $flatc_version$) on " __DATE__ "  \n");
    ...
    static void PrintMethodFields(Printer* p, VARS& vars,
        ...
        for (int i = 0; i < service->method_count(); ++i) {
            ...
            p->Print(
                     ...
                     "                $input_type$.class, $input_type$::getRootAs$input_type_name$))\n"
                     "            .setResponseMarshaller(FlatbuffersUtils.marshaller(\n"
                     "                $output_type$.class, $output_type$::getRootAs$output_type_name$))\n"
            );
