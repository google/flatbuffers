    ...
    static void PrintMethodFields(Printer* p, VARS& vars,
        ...
        for (int i = 0; i < service->method_count(); ++i) {
            ...
            p->Print(
                     ...
                     "\n"
                     "private static final FlatbuffersUtils.FBExtactor<$input_type$> extractorOf$input_type_name$ =\n"
                     "    new FlatbuffersUtils.FBExtactor<$input_type$>() {\n"
                     "    public $input_type$ extract (ByteBuffer buffer) {\n"
                     "        return $input_type$.getRootAs$input_type_name$(buffer);\n"
                     "    }\n"
                     "};\n"
                     "private static final FlatbuffersUtils.FBExtactor<$output_type$> extractorOf$output_type_name$ =\n"
                     "    new FlatbuffersUtils.FBExtactor<$output_type$>() {\n"
                     ...
                     "                $input_type$.class, extractorOf$input_type_name$))\n"
                     "            .setResponseMarshaller(FlatbuffersUtils.marshaller(\n"
                     "                $output_type$.class, extractorOf$output_type_name$))\n"
            );
